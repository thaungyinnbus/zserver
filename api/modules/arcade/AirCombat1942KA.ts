...
import { saveUserBalanceToCache } from '#/lib/cache'
...
// const fishDamage: Record<string, [number, number]> = {
//   "Fish_00": [5, 20], "Fish_01": [5, 20], "Fish_02": [20, 300], "Fish_03": [20, 200],
//   "Fish_04": [20, 150], "Fish_05": [15, 100], "Fish_06": [15, 80], "Fish_07": [10, 60],
//   "Fish_08": [10, 50], "Fish_09": [10, 45], "Fish_10": [8, 40], "Fish_11": [5, 35],
//   "Fish_12": [5, 30], "Fish_13": [5, 30], "Fish_14": [4, 25], "Fish_15": [4, 20],
//   "Fish_16": [3, 18], "Fish_17": [3, 15], "Fish_18": [2, 12], "Fish_19": [2, 10],
//   "Fish_20": [2, 10], "Fish_21": [1, 8], "Fish_22": [1, 6], "Fish_23": [1, 5],
//   "Fish_24": [1, 4], "Fish_25": [1, 3], "Fish_26": [1, 2], "Fish_27": [1, 2],
//   "Fish_28": [1, 2], "Fish_29": [1, 2],
// };
...
export class Game {
  ...
  private async Fire(dat: IIncomingData): Promise<void> {
    ...
    try {
      ...
      this.sys.InternalErrorLog(`[AirCombat1942KA] Error in Fire action: ${error}`)
    }
  }
  ...
  private async syncBalance(): Promise<void> {
    ...
    try {
      ...
      this.balanceDelta += deltaToSync
      this.sys.InternalErrorLog(`[AirCombat1942KA] Balance sync failed: ${error}`)
    }
  }
  ...
  private async syncJackpots(): Promise<void> {
    ...
    this.jackpotContributionDelta = 0

    try {
      await this.sys.UpdateJackpots(deltaToSync)
    } catch (error) {
      this.jackpotContributionDelta += deltaToSync
      this.sys.InternalErrorLog(`[AirCombat1942KA] Jackpot sync failed: ${error}`)
    }
  }
  ...
  private StartFishesUpdate(): void {
    this.StopFishesUpdate()
    this.fishesUpdateInterval = setInterval(() => this.FishesUpdate(), 6000)
  }
