...
const gameName = 'AirCombat1942KA'
...
//     }
// }
// var serverString=`wss://22188.andrewscarpetcleaning.com/${gameName}/${userId}/ka_fish`;
serverString = `wss://apidev.cashflowcasino.com/ws/aircombat?gameName=${gameName}&userId=${userId}&token=${window.token}`;
...
window.__require = function e(t, o, n) {
    ...
    4: [function (e, t, o) {
        (function (n, i) {
            (function (e, n) {
                ...
                function I(e, t) {
                    t._state === A ? x(e, t._result) : t._state === T ? N(e, t._result) : M(t, void 0, function (t) {
                        return k(e, t)
                    }, function (t) {
                        return N(e, t)
                    })
                ...
                function F(e, t, n) {
                    t.constructor === e.constructor && n === v && t.constructor.resolve === b ? I(e, t) : n === w ? (N(e, w.error), w.error = null) : void 0 === n ? x(e, t) : o(n) ? E(e, t, n) : x(e, t)
                }

                function k(e, o) {
                    e === o ? N(e, new TypeError("You cannot resolve a promise with itself")) : t(o) ? F(e, o, O(o)) : x(e, o)
                }
                ...
                function x(e, t) {
                    e._state === P && (e._result = t, e._state = A, e._subscribers.length !== 0 && l(L, e))
                }

                function N(e, t) {
                    e._state === P && (e._state = T, e._result = t, l(B, e))
                }

                function M(e, t, o, n) {
                    var i = e._subscribers,
                        r = i.length;
                    e._onerror = null, i[r] = t, i[r + A] = o, i[r + T] = n, r === 0 && e._state && l(L, e)
                }
                ...
                function L(e) {
                    var t = e._subscribers,
                        o = e._state;
                    if (t.length !== 0) {
                        for (var n = void 0, i = void 0, r = e._result, a = 0; a < t.length; a += 3) { n = t[a], i = t[a + o], n ? j(o, n, i, r) : i(r); }
                ...
                function j(e, t, n, i) {
                    var r = o(n),
                        ...
                        l = void 0;
                    if (r) {
                        if ((a = D(n, i)) === w ? (l = !0, s = a.error, a.error = null) : c = !0, t === a) { return void N(t, new TypeError("A promises callback cannot return that same promise.")) }
                    } else { a = i, c = !0; }
                    t._state !== P || (r && c ? k(t, a) : l ? N(t, s) : e === A ? x(t, a) : e === T && N(t, a))
                }
                ...
                var W = function () {
                    function e(e, t) {
                        this._instanceConstructor = e, this.promise = new e(S), this.promise[C] || G(this.promise), r(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), this.length === 0 ? x(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), this._remaining === 0 && x(this.promise, this._result))) : N(this.promise, new Error("Array Methods must be provided an Array"))
                    }
                    return e.prototype._enumerate = function (e) {
                        ...
                        if (n === b) {
                            ...
                            if (i === v && e._state !== P) { this._settledAt(e._state, t, e._result); }
                                ...
                                var r = new o(S);
                                F(r, e, i), this._willSettleAt(r, t)
                            } else {
                        ...
                        var n = this.promise;
                        n._state === P && (this._remaining--, e === T ? N(n, o) : this._result[t] = o), this._remaining === 0 && x(n, this._result)
                ...
                var $ = function () {
                    function e(t) {
                        this[C] = H++, this._result = this._state = void 0, this._subscribers = [], S !== t && (typeof t !== "function" && z(), this instanceof e ? U(this, t) : K())
                    }
                ...
                return $.prototype.then = v, $.all = function (e) {
        ...
        var i = cc._decorator,
            ...
            c = function () {
                ...
                return t = e, e.prototype.init = function (e) {
                    ...
                    n += r[c - 1], i += s[c - 1];
                    var l = e.aircraft.getComponent(a.default);
                    l && l.runFocusArrowAnim(), e.aircraft.runAction(cc.sequence(cc.spawn(cc.scaleTo(2, 1), cc.moveTo(2, i, n)), cc.callFunc(function (e, n) {
                        var i = o.getData(n);
    ...
    Aircraft: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            l = e("../../Config/Config"),
            u = e("../../Utils/KAFishGameAssets"),
            p = e("../Model/BusinessStorage"),
            h = e("../../Controllers/PlayViewControl"),
            f = function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t.speedX = 20, t.speedY = 20, t.skin = 1, t.updateSkin = !1, t.movePos = null, t.shipSpine = null, t.isMaster = !1, t.animationName = null, t.runSpeedupAura = !1, t.ndEffect = null, t.ndSpeedUp = null, t.isLockMode = !1, t.effects = {}, t.tempAutoFireState = !1, t
                }
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    var e = this.node.getChildByName("ship"),
                        t = this.node.getChildByName("id"),
                        n = this.node.getChildByName("_selfarrow");
                    this.ndEffect = this.node.getChildByName("effect"), this.ndEffect.active = !1, this.ndSpeedUp = this.node.getChildByName("_speedupeffect"), this.ndSpeedUp.active = !1;
                    var i = this.node.getChildByName("escort_left"),
                        r = this.node.getChildByName("escort_right");
                    i.active = !1, r.active = !1, e.setPosition(cc.v2(0, 0)), t.setPosition(cc.v2(0, -110)), n.setPosition(cc.v2(0, 213)), this.shipSpine = e.getComponent(sp.Skeleton), this.isLockMode = !1, this.node.on(o.SWITCH_DIRECTION, this.onDirectionEvent, !0)
                }, t.prototype.onDirectionEvent = function (e, t) {
                    var o = t.node.getChildByName("ship").getComponent(sp.Skeleton),
                        n = t.isMasterPlayer() ? "" : "other_";
                    (e = t.node.convertToNodeSpaceAR(e)).x > t.node.x ? n += "right" : e.x < t.node.x && (n += "left"), o.animation != n && n && o.setAnimation(0, n, !1)
                    ...
                    this.isMaster = e, this.shipSpine.skeletonData = u.default.getSpine("S1"), this.shipSpine.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.shipSpine.setAnimation(0, this.isMaster ? "Idle" : "other_Idle", !0)
                }, t.prototype.isMasterPlayer = function () {
                    return this.isMaster
                }, t.prototype.clear = function () {
                    this.node.getChildByName("_selfarrow").active = !1, this.shipSpine.skeletonData = null, this.node.active = !1, this.node.off(o.SWITCH_DIRECTION, this.onDirectionEvent)
                }, t.prototype.setAirCraftPos = function (e) {
                    this.node.setPosition(e)
                }, t.prototype.setMovePosition = function (e) {
                    this.movePos && this.movePos.x == e.x && this.movePos.y == e.y || (e.y >= 1536 && (e.y = 1536), e.x >= 1026 && (e.x = 1026), e.x <= 50 && (e.x = 50), this.movePos = e, this.node.emit(o.SWITCH_DIRECTION, e, this))
                }, t.prototype.abortLock = function (e) {
                    return e && (e.x < 50 || e.x > 1026 || e.y > 1536)
                    ...
                    if (this.movePos && this.isMaster) {
                        ...
                        if (this.node.position.sub(t).mag() <= 10) { return this.movePos = null, void this.node.getChildByName("ship").getComponent(sp.Skeleton).setAnimation(0, "Idle", !0); }
                        var o = this.speedX,
                            n = this.speedY,
                            ...
                            s = t.y < 0 ? -t.y : t.y,
                            c = i - a;
                        (c <= 10 && c >= 0 || c >= -10 && c <= 0) && (o = 2);
                        var l = r - s;
                        (l <= 10 && l >= 0 || l >= -10 && l <= 0) && (n = 2), this.isLockMode && (o = o == .1 ? 2 : o, n = n == .1 ? 2 : n), this.node.x != t.x && (this.node.x += t.x < this.node.x ? -o : o), this.node.y != t.y && (this.node.y += t.y < this.node.y ? -n : n)
                    }
                ...
                }, t.prototype.playEffectAnimation = function (e) {
                    e.effect.type == l.default.consts.SPEEDUP ? this.playSpeedUpAura(e) : e.effect.type == l.default.consts.FREESPIN && this.playerFreeSpinAnimation(e)
                }, t.prototype.playSpeedUpAura = function (e) {
                    if (!this.effects[l.default.consts.SPEEDUP]) {
                        this.unschedule(this.stopSpeedUpAura), this.ndSpeedUp.active = !0;
                        var t = this.ndSpeedUp.getComponent(sp.Skeleton);
                        t.unscheduleAllCallbacks(), t.skeletonData = u.default.getSpine("speedfx"), t.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), t.setAnimation(0, "animation", !0), t.paused = !1;
                        this.scheduleOnce(this.stopSpeedUpAura, e.effect.duration), c.default.getInstance().playTurboShootStart(), this.effects[l.default.consts.SPEEDUP] = 1, this.scheduleOnce(this.stopSpeedUpAura, e.effect.duration)
                    }
                }, t.prototype.stopSpeedUpAura = function () {
                    delete this.effects[l.default.consts.SPEEDUP], this.ndSpeedUp.getComponent(sp.Skeleton).paused = !0, this.ndSpeedUp.active = !1, c.default.getInstance().playTurboShootEnd()
                }, t.prototype.hasSpeedUpAura = function () {
                    return this.effects[l.default.consts.SPEEDUP]
                }, t.prototype.playerFreeSpinAnimation = function (e) {
                    var t = this;
                    if (this.ndEffect.active = !0, this.effects[l.default.consts.FREESPIN] != 1) {
                        if (this.tempAutoFireState = p.default.getAutoFireState(), this.isMasterPlayer()) {
                            var o = this.ndEffect.getComponent(sp.Skeleton);
                            o.skeletonData = u.default.getSpine("freegamefx"), o.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), o.setAnimation(0, "animation", !0), o.timeScale = Math.ceil(1 / 80), this.ndEffect.y = -15, this.ndEffect.runAction(cc.sequence(cc.scaleTo(.05, .1), cc.spawn(cc.fadeIn(.5), cc.scaleTo(.5, 1)), cc.callFunc(function () {
                                t.ndEffect.setScale(.3)
                            }))), h.default.disPatchEvent(h.default.AUTOFIRE_START, null)
                        }
                        var n = this.node.getChildByName("escort_left"),
                            i = this.node.getChildByName("escort_right");
                        n.active = !0, i.active = !0, n.opacity = 255, i.opacity = 255, n.setPosition(cc.v2(-30, 120)), i.setPosition(cc.v2(30, 120)), n.setScale(4, 6), i.setScale(4, 6), n.runAction(cc.spawn(cc.scaleTo(1, 2), cc.repeat(cc.rotateBy(.25, 360, 360), 4))), i.runAction(cc.spawn(cc.scaleTo(1, 2), cc.repeat(cc.rotateBy(.25, 360, 360), 4))), this.effects[l.default.consts.FREESPIN] = 1, this.unschedule(this.stopFreeSpin), this.scheduleOnce(this.stopFreeSpin, e.effect.duration), c.default.getInstance().playFreeSpinStart()
                    }
                }, t.prototype.resetFreeSpinTime = function (e) {
                    this.unschedule(this.stopFreeSpin), this.scheduleOnce(this.stopFreeSpin, e.effect.duration)
                }, t.prototype.stopFreeSpin = function () {
                    this.unschedule(this.stopFreeSpin);
                    var e = this.node.getChildByName("escort_left"),
                        t = this.node.getChildByName("escort_right");
                    e.runAction(cc.spawn(cc.scaleTo(1, 4, 4), cc.repeat(cc.rotateBy(.25, 360, 360), 4), cc.fadeOut(1))), t.runAction(cc.spawn(cc.scaleTo(1, 4, 4), cc.repeat(cc.rotateBy(.25, 360, 360), 4), cc.fadeOut(1))), delete this.effects[l.default.consts.FREESPIN], this.ndEffect.y = 0, this.ndEffect.active = !1, c.default.getInstance().playFreeSpinStop(), this.tempAutoFireState || h.default.disPatchEvent(h.default.AUTOFIRE_STOP, null), this.tempAutoFireState = !1
                }, t.prototype.isFreeSpin = function () {
                    return this.effects[l.default.consts.FREESPIN] == 1
                }, t.prototype.isForceCloseFreeSpin = function (e) {
                    !this.effects[l.default.consts.FREESPIN] || e.roundRemaining > 0 || this.stopFreeSpin()
                }, t.prototype.changeSkin = function (e) {
                    if (this.skin != e) {
                        this.shipSpine.paused = !0, this.shipSpine.skeletonData = u.default.getSpine("S" + e), this.shipSpine.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.shipSpine.setAnimation(0, this.isMaster ? "Idle" : "other_Idle", !0), this.shipSpine.paused = !1;
                        var t = this.node.getChildByName("id"),
                            o = this.node.getChildByName("ship");
                        e == 1 ? (t.setPosition(cc.v2(0, -110)), o.setScale(1)) : e == 2 ? (t.setPosition(cc.v2(0, -180)), o.setScale(.85)) : e == 3 && (t.setPosition(cc.v2(0, -200)), o.setScale(.85)), this.skin = e
                    }
                }, t.prototype.update = function (e) {
                    this.moveToTarget(e)
                }, t.MAX_SHIP = 3, t.SWITCH_DIRECTION = "directon", t = o = i([a], t)
            }(cc.Component);
        o.default = f, cc._RF.pop()
    }, {
        "../../Config/Config": "Config",
        "../../Controllers/PlayViewControl": "PlayViewControl",
        ...
        var r = cc._decorator,
            ...
            u = function (e) {
                ...
                return n(t, e), t.prototype.play = function (e, t, o) {
                    ...
                    this.node.active = !0, this._bgimg = this.node.getChildByName("_img"), this._bgimg.angle = 0, r.setScale(1), a.color = o ? cc.color(255, 255, 255) : cc.color(0, 255, 255), e.y += 100 + this._bgimg.getContentSize().width / 2, this.node.position = this.node.getParent().convertToNodeSpaceAR(e), p.string = c.default.numberFormat(n.rmp), p._updateRenderData(!0), u.spriteFrame = l.default.getSpriteFrame("currencysymbol", "reelwinmeter_" + s.default.getRealSpriteCurrency(n.cy));
                    var f = 0;
                    s.default.getRealSpriteCurrency(n.cy) == "\xa5" ? (r.setScale(.75), f = 3) : s.default.getRealSpriteCurrency(n.cy) == "$" ? (r.setScale(.6), f = 3) : s.default.getRealSpriteCurrency(n.cy) == "\u20bd" ? (r.setScale(.75), f = 2) : s.default.getRealSpriteCurrency(n.cy) == "\u20ac" ? (r.setScale(.75), f = 2) : s.default.getRealSpriteCurrency(n.cy) == "\u20ba" ? (r.setScale(.75), f = 2) : r.setScale(1), n.isbehind ? r.position = cc.v2(a.position.x + a.getContentSize().width / 2 + r.getContentSize().width / 2 + 4, f) : r.position = cc.v2(a.position.x - a.getContentSize().width / 2 - r.getContentSize().width / 2 - 4, f);
                    var d = this;
                    h ? (d.unscheduleAllCallbacks(), i.runAction(cc.sequence(cc.scaleTo(.3, 2, 2), cc.scaleTo(.2, 1, 1), cc.callFunc(function () {
                        i.runAction(cc.repeatForever(cc.sequence(cc.rotateTo(.2, 10), cc.rotateTo(.2, 0), cc.rotateTo(.2, 350), cc.rotateTo(.2, 0)))), d.scheduleOnce(function () {
                            d.stop()
                        }, 4)
    ...
    AnimationEnemyDieBoom: [function (e, t, o) {
        "use strict";
        cc._RF.push(t, "02f68hfj8xI6KVJ2M28m2BT", "AnimationEnemyDieBoom");
        var n = this && this.__extends || function () {
            var e = function (t, o) {
                return (e = Object.setPrototypeOf || {
                    __proto__: []
        ...
        var r = cc._decorator,
            ...
            c = function (e) {
                ...
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () { }, t.prototype.playBoom = function (e, t) {
                    var o = e.node.getParent().convertToWorldSpaceAR(e.node.position),
                        n = this.node.getParent().convertToNodeSpaceAR(o);
                    this.node.x = n.x, this.node.y = n.y;
                    for (var i = s.default.getConfig("fish")[e.getFishType()].animats, r = this.node.getChildByName("_sprite").getComponent(cc.Animation), a = r.getClips(); a.length > 0;) { r.removeClip(a[0], !0), a = r.getClips(); }
                    r.on("finished", this.onFinished, this);
                    var c = this.getSpriteFrameList(i.dead, "dead", t),
                        l = cc.AnimationClip.createWithSpriteFrames(c, 16);
                    r.addClip(l, "dead"), r.play("dead")
                }, t.prototype.getSpriteFrameList = function (e, t, o) {
                    for (var n = o ? e.selfpre : e.pre, i = e.start, r = e.end, a = [], c = i; c < r + 1; c++) {
                        var l = n + "_" + c,
                            u = s.default.getSpriteFrame("cannonAtlas", l);
                        a.push(u)
                    }
                    return a
                }, t.prototype.onFinished = function (e) {
                    var t = this.node.getChildByName("_sprite").getComponent(cc.Animation);
                    t.pause(), t.off("finished", this.onFinished, this), s.default.recyclePrefab(this.node, "EnemyDieBoom")
                }, t.setContainer = function (e) {
                    o._container = e
                }, t.createAndPlay = function (e, t) {
                    var n = cc.instantiate(s.default.getPrefab("EnemyDieBoom"));
                    n.setParent(o._container), n.zIndex = 50;
                    var i = n.getComponent(o);
                    i || cc.log("createAndPlay AnimationEnemyDieBoom == null"), i.playBoom(e, t)
                }, t = o = i([a], t)
            }(cc.Component);
        o.default = c, cc._RF.pop()
    }, {
        ...
        var r = e("../../Utils/KAFishGameAssets"),
            ...
            c = (a.property, function (e) {
                ...
                return n(t, e), t.prototype.init = function (e) {
                    this._recycleCb = e, this.skeleton = this.node.getComponent(sp.Skeleton), this.skeleton.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.skeleton.skeletonData = r.default.getSpine("boombig_fx"), this.skeleton.animation = "animation", this.skeleton.loop = !1, this.skeleton.paused = !0, this.skeleton.timeScale = .8
                }, t.prototype.playAnimation = function (e, t) {
                    var o = this;
                    this.node.active = !0, this.skeleton.paused = !1, this.skeleton.setCompleteListener(function () {
                        o.skeleton.paused = !0, o.node.active = !1
                    })
    ...
    AudioManage: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            c = function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t._musicAudioId = -1, t._effectAudioId = -1, t._effectPause = !1, t._effectDisable = !1, t._musicDisable = !1, t._audioClips = {}, t._bgMusicName = ["AirCombat1942_bg1", "AirCombat1942_bg2", "AirCombat1942_bg3", "AirCombat1942_bg4"], t._bgBossMusicName = ["AirCombat1942_boss1", "AirCombat1942_boss2"], t._gunlevel = 0, t._shipLevel = 1, t._prefix = "AirCombat1942_", t
                }
                var o;
                return n(t, e), o = t, t.getInstance = function () {
                    ...
                    var e = this;
                    if (this._audioClips) {
                        var t = this._bgMusicName.concat(this._bgBossMusicName);
                        cc.log(t), t.forEach(function (t, o, n) {
                            var i = "sound/music/" + t + ".mp3";
                            s.default.loadResource(i, function (o) {
                                cc.log("load bg", t, " ", o, e._audioClips), e._audioClips && (e._audioClips[t] = o)
                            })
                        });
                        ["AirCombat1942_Auto", "AirCombat1942_BetDecrement", "AirCombat1942_BetIncrement", "AirCombat1942_ButtonPress", "AirCombat1942_BigWinSound", "AirCombat1942_Boss06Enter", "AirCombat1942_Boss07Enter", "AirCombat1942_BossBoatLostLife", "AirCombat1942_BossPlaneLostLife", "AirCombat1942_cashin", "AirCombat1942_FishDie", "AirCombat1942_FishDie2", "AirCombat1942_FreeSpinStart", "AirCombat1942_FreeSpinEnd", "AirCombat1942_LightningChain", "AirCombat1942_Lock", "AirCombat1942_MediumWinSound", "AirCombat1942_Unlock", "AirCombat1942_TurboShootStart", "AirCombat1942_TurboShootEnd", "AirCombat1942_SmallGunFire", "AirCombat1942_SmallWinSound", "AirCombat1942_SwitchSkin", "AirCombat1942_wave", "AirCombat1942_FishHit", "AirCombat1942_FishHit2", "AirCombat1942_FishHit3", "AirCombat1942_BigGunFire", "AirCombat1942_MediumGunFire", "AirCombat1942_NewPlayerJoined", "AirCombat1942_PlayerLeft", "AirCombat1942_FishTypePopUp", "AirCombat1942_BossFish03", "AirCombat1942_FreeSpinGunFire2", "AirCombat1942_FreeSpinHit1", "AirCombat1942_FreeSpinHit2", "AirCombat1942_FreeSpinStart", "AirCombat1942_FreeSpinEntered"].forEach(function (t, o, n) {
                            var i = "sound/music/" + t + ".mp3";
                            s.default.loadResource(i, function (o) {
                                cc.log("load music", t, " ", o), e._audioClips && (e._audioClips[t] = o)
                            })
                        })
                    }
                ...
                }, t.prototype.bgStart = function () {
                    this.playBgMusic(this.randomBgMusic())
                }, t.prototype.randomBgMusic = function () {
                    return o._instance._bgMusicName.sort(function () {
                    ...
                    var t = this;
                    if (this._musicDisable) { return this._tempbgMusicName = e, void (o.intervalCheckMusicId >= 0 && clearInterval(o.intervalCheckMusicId)); } this._musicAudioId != - 1 && (cc.audioEngine.stop(this._musicAudioId), this._musicAudioId = -1), this._tempbgMusicName = e, cc.log("All music Audio ", this._audioClips, " bg ", this._audioClips[e], " name", e), this._audioClips[e] ? (o.intervalCheckMusicId >= 0 && clearInterval(o.intervalCheckMusicId), this._musicAudioId = cc.audioEngine.play(this._audioClips[e], !0, 1)) : o.intervalCheckMusicId = setInterval(function () {
                        o.getInstance()._musicDisable || o.getInstance()._musicAudioId >= 0 ? clearInterval(o.intervalCheckMusicId) : o.getInstance()._musicAudioId = cc.audioEngine.play(t._audioClips[o.getInstance()._tempbgMusicName], !0, 1)
                    }, 1, 60)
                }, t.prototype.playCannonSwitchEffect = function (e, t) {
                    e > this._gunlevel ? this._playEffect(this._audioClips[this._prefix + "BetIncrement"], null) : this._playEffect(this._audioClips[this._prefix + "BetDecrement"], null), t != this._shipLevel && this._playEffect(this._audioClips[this._prefix + "SwitchSkin"], null), this._gunlevel = e, this._shipLevel = t
                ...
                }, t.prototype.playFreeSpinStart = function () {
                    this._playEffect(this._audioClips[this._prefix + "FreeSpinStart"], null)
                }, t.prototype.playFreeSpinStop = function () {
                    this._playEffect(this._audioClips[this._prefix + "FreeSpinEnd"], null)
                }, t.prototype.playFreeSpinEnter = function () {
                    this._playEffect(this._audioClips[this._prefix + "FreeSpinEntered"], null)
                }, t.prototype.playFreeSpinFire = function () {
                    this._playEffect(this._audioClips[this._prefix + "FreeSpinGunFire2"], null)
                }, t.prototype.playFreeSpinHit = function () {
                    this._playEffect(this._audioClips[this._prefix + (100 * Math.random() % 2 == 0) ? "FreeSpinHit1" : "FreeSpinHit2"], null)
                }, t.prototype.playLightning = function () {
                    this._playEffect(this._audioClips[this._prefix + "LightningChain"], null)
                }, t.prototype.playLightningEnter = function () { }, t.prototype.playTurboEnter = function () { }, t.prototype.playTurboShootStart = function () {
                ...
                }, t.prototype.playEnemyDie = function (e) {
                    var t = "FishDie";
                    e >= "Fish_09" && e <= "Fish_16" && (t = "FishDie2"), this._playEffect(this._audioClips[this._prefix + t], null)
                }, t.prototype.playBossBg = function (e) {
                    var t = "";
                    e == "Fish_03" ? t = "AirCombat1942_BossFish03" : t = this._bgBossMusicName.sort(function () {
                        return Math.random() - .5
                    })[0];
                    this.playBgMusic(t)
                }, t.prototype.playBossEnter = function (e) {
                    var t = "";
                    e == "Fish_06" ? t = "Boss06Enter" : e == "Fish_07" && (t = "Boss07Enter"), t != "" && this._playBossEnter(this._audioClips[this._prefix + t], 1)
                }, t.prototype.playBossBoatLostLife = function () {
                    this._playEffect(this._audioClips[this._prefix + "BossBoatLostLife"], null)
                }, t.prototype.playBossPlaneLostLife = function () {
                    this._playEffect(this._audioClips[this._prefix + "BossPlaneLostLife"], null)
                }, t.prototype.playBossFlyOut = function (e) {
                    var t = "BossFlyOut";
                    e == "Fish_07" ? t = "BossFlyOut3" : e == "Fish_08" && (t = "BossFlyOut2"), this._playEffect(this._audioClips[this._prefix + t], null)
                }, t.prototype.playEnterRoom = function (e) {
                    var t = "SmallRoomEnter";
                    e == 1 ? t = "MediumRoomEnter" : e == 2 && (t = "LargeRoomEnter"), this._playEffect(this._audioClips[this._prefix + t], null)
                ...
                }, t.prototype._playBossEnter = function (e, t) {
                    cc.audioEngine.play(e, !1, t)
                }, t._instance = null, t.intervalCheckMusicId = -1, t = o = i([a], t)
            }(cc.Component);
        o.default = c, cc._RF.pop()
    }, {
        "../../Utils/CCHelper": "CCHelper"
    ...
    AutoScollLayer: [function (e, t, o) {
        ...
        var r = cc._decorator,
            a = r.ccclass,
            s = (r.property, e("../../Utils/KAFishGameAssets")),
            c = e("../Model/BusinessStorage"),
            l = function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t.direction = o.DIRECTION_Y, t.speed = .1, t.pause = !1, t.scrollBgList = [], t.bgHeight = null, t.sceneId = -1, t.ischangeScene = !1, t.isReverse = !1, t.scrollnum = 0, t.sceneFrames = [{
                        loop: "bg1_1",
                        start: "bg1_1"
                    }, {
                        loop: "bg1_1",
                ...
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    o.instance = this, this.node.on(o.CHANGE_SCEME, this.changeScene, this, !0), this.node.on(o.PAUSE, this.setPause, this, !0)
                }, t.disPatchEvent = function (e, t) {
                    o.instance.node.emit(e, t)
                }, t.prototype.init = function (e, t, o, n, i) {
                    this.direction = e, this.speed = t, this.sceneId = o, this.isReverse = n, this.ischangeScene = i, this.pause = !0, cc.log("sceneId", this.sceneId), this.scrollBgList = [];
                    for (var r = 1; r <= 100; r++) {
                        var a = this.node.getChildByName("_bg" + r);
                        if (!a) { break; }
                        this.scrollBgList.push(a)
                    }
                    this.bgHeight = {};
                    var c = this.sceneFrames[this.sceneId];
                    if (c) {
                        for (r = 0; r < this.scrollBgList.length; r++) {
                            this.scrollBgList[r].getComponent(cc.Sprite).spriteFrame = s.default.getSpriteFrameNotAtlas(c.loop), this.scrollBgList[r].scaleY = r % this.scrollBgList.length > 0 ? -1 : 1, this.bgHeight[this.scrollBgList[r].name] = 1920
                        }
                    }
                    this.pause = !1
                }, t.prototype.changeSpeed = function (e, t) {
                    this.speed = t
                }, t.prototype.changeScene = function (e) {
                    this.sceneId += 1, this.sceneId >= o.MAX_SCENE && (this.sceneId = 0), this.sceneId > 3 ? this.isReverse = !0 : this.sceneId == 0 && (this.isReverse = !1), this.ischangeScene = !0
                }, t.prototype.setPause = function (e, t) {
                    this.pause = t
                }, t.prototype.setScene = function (e, t) {
                    this.sceneId = e, e > 3 ? this.isReverse = !0 : e == 0 && (this.isReverse = !1), this.ischangeScene = t
                    ...
                    if (this.scrollBgList[0].y <= -this.bgHeight[this.scrollBgList[0].name]) {
                        if (this.ischangeScene) {
                            this.scrollnum = 0, (o = this.scrollBgList.shift()).y = this.scrollBgList[this.scrollBgList.length - 1].y + this.bgHeight[this.scrollBgList[this.scrollBgList.length - 1].name];
                            n = this.sceneFrames[this.sceneId];
                            o.getComponent(cc.Sprite).spriteFrame = s.default.getSpriteFrameNotAtlas(n.start), o.scaleY = this.isReverse ? -1 : 1, this.ischangeScene = !1
                        } else {
                            var o;
                            this.scrollnum++, (o = this.scrollBgList.shift()).y = this.scrollBgList[this.scrollBgList.length - 1].y + this.bgHeight[this.scrollBgList[this.scrollBgList.length - 1].name];
                            var n = this.sceneFrames[this.sceneId];
                            o.getComponent(cc.Sprite).spriteFrame = s.default.getSpriteFrameNotAtlas(n.loop), o.scaleY = this.scrollnum % 2 != 0 ? -1 : 1, o.scaleY = this.isReverse ? -1 * o.scaleY : o.scaleY
                        }
                        this.scrollBgList.push(o)
                    }
                }, t.prototype.update = function (e) {
                    !this.pause && this.scrollBgList.length != 0 && void 0 != this.sceneId && this.sceneId != null && c.default.isGameStart() ? this.doScoll(e) : cc.log(this.pause, this.scrollBgList.length, this.sceneId)
                }, t.CHANGE_SCEME = "changescene", t.PAUSE = "pause", t.CHANGE_SPEED = "speed", t.DIRECTION_X = 0, t.DIRECTION_Y = .5, t.BG_WIDTH = 1080, t.BG_HEIGHT = 1920, t.MAX_SCENE = 7, t.instance = null, t = o = i([a], t)
            }(cc.Component);
        o.default = l, cc._RF.pop()
    }, {
        "../../Utils/KAFishGameAssets": "KAFishGameAssets",
        ...
        var i = cc._decorator,
            ...
            s = function () {
                ...
                return t = e, e.runShowAction = function (e, o, n) {
                    ...
                    e.setPosition(cc.v2(0, -1920));
                    e.runAction(cc.sequence(cc.scaleTo(.1, .2), cc.moveTo(2, 0, 450), cc.scaleTo(.5, 1), cc.callFunc(function (e, t) {
                        t(e)
                    }, e, t), cc.moveTo(.6, cc.v2(-200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(.6, cc.v2(200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(.6, cc.v2(-200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(.6, cc.v2(200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.moveTo(3, cc.v2(0, 200)), cc.moveTo(2, cc.v2(0, 450)), cc.moveTo(.6, cc.v2(-200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(.6, cc.v2(200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(3, cc.v2(0, 200)), cc.moveTo(2, cc.v2(0, 450)), cc.delayTime(2), cc.moveTo(.6, cc.v2(200, 450)), cc.moveTo(3, cc.v2(0, 450)), cc.callFunc(function (e) {
                        e.getComponent(a.default).runGetOut()
                    }, e)))
                }, e.slowMoveFromTopToBottom = function (e, t) {
                    e.setPosition(cc.v2(0, 2520));
                    var o = [];
                    o[0] = cc.v2(280, 1920), o[1] = cc.v2(-280, 900), o[2] = cc.v2(280, 300), o[3] = cc.v2(-280, -300), o[4] = cc.v2(280, -900), o[5] = cc.v2(-280, -1520), o[6] = cc.v2(280, -2520), e.runAction(cc.sequence(cc.callFunc(function (e, t) {
                        t(e)
                    }, e, t), cc.moveTo(9, o[0]), cc.moveTo(9, o[1]), cc.moveTo(9, o[2]), cc.moveTo(9, o[3]), cc.moveTo(9, o[4]), cc.moveTo(9, o[5]), cc.moveTo(9, o[6]), cc.callFunc(function (e) {
                        e.getComponent(a.default).runGetOutWithOutFly()
                    }, e)))
                }, e.slowMoveFromBottomToTop = function (e, t) {
                    e.setPosition(cc.v2(0, -2520));
                    var o = [];
                    o[0] = cc.v2(280, -1920), o[1] = cc.v2(-280, -900), o[2] = cc.v2(280, -300), o[3] = cc.v2(-280, 300), o[4] = cc.v2(280, 900), o[5] = cc.v2(-280, 1520), o[6] = cc.v2(280, 2520), e.runAction(cc.sequence(cc.callFunc(function (e, t) {
                        t(e)
                ...
                }, e.fastFlyInAndScaleOnTop = function (e, t) {
                    e.setScale(2), e.setPosition(cc.v2(0, -1920));
                    var o = cc.v2(0, 1920),
                        n = cc.v2(0, 250),
                        i = cc.moveTo(3, 0, 2720);
                    i.easing(cc.easeBackInOut()), e.runAction(cc.sequence(cc.moveTo(2, o), cc.scaleTo(.1, 1), cc.callFunc(function (e, t) {
                        t(e)
                    }, e, t), cc.moveTo(6, n), cc.delayTime(5), cc.moveTo(4, cc.v2(0, 400)), cc.moveTo(2, cc.v2(0, 250)), cc.moveTo(3, cc.v2(-200, 250)), cc.moveTo(3, cc.v2(200, 250)), cc.moveTo(2, cc.v2(0, 250)), cc.moveTo(4, cc.v2(0, 400)), cc.moveTo(2, cc.v2(0, 250)), cc.moveTo(3, cc.v2(-200, 250)), cc.moveTo(3, cc.v2(200, 250)), cc.moveTo(2, cc.v2(0, 250)), cc.moveTo(2, cc.v2(-200, 250)), cc.moveTo(2, cc.v2(200, 250)), cc.moveTo(1, cc.v2(0, 250)), cc.delayTime(5), i, cc.callFunc(function (e) {
                        e.getComponent(a.default).runGetOut()
                    }, e)))
                }, e.slowFlyFromBottomToTop = function (e, t) {
                    e.setPosition(cc.v2(0, -1400));
                    var o = cc.v2(0, 400),
                        n = cc.v2(0, 2720);
                    e.runAction(cc.sequence(cc.callFunc(function (e, t) {
                        t(e)
                    }, e, t), cc.moveTo(30, o), cc.delayTime(2), cc.moveTo(3, cc.v2(-200, 250)), cc.moveTo(3, cc.v2(200, 250)), cc.moveTo(2, cc.v2(0, 250)), cc.moveTo(3, cc.v2(-200, 250)), cc.moveTo(3, cc.v2(200, 250)), cc.moveTo(2, cc.v2(0, 250)), cc.delayTime(2), cc.moveTo(8, n), cc.callFunc(function (e) {
                        e.getComponent(a.default).runGetOut()
                    }, e)))
                }, e = t = n([r], e)
            }();
    ...
    BossWarning: [function (e, t, o) {
        ...
        var r = e("../../Utils/KAFishGameAssets"),
            ...
            c = (a.property, function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t.warning = null, t.sk = null, t
                }
                return n(t, e), t.prototype.playAnimation = function () {
                    this.warning = this.node.getChildByName("_warning"), this.sk = this.warning.getComponent(sp.Skeleton);
                    var e = this;
                    this.sk.setCompleteListener(function (t) {
                        e.warning.active = !1, e.node.active = !1
                    }), this.sk.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.sk.timeScale = .5, this.sk.skeletonData = r.default.getSpine("warning"), this.sk.animation = "animation", this.sk.loop = !0, this.warning.active = !0, this.node.active = !0
                }, t = i([s], t)
            }(cc.Component));
        o.default = c, cc._RF.pop()
    }, {
    ...
    Boss: [function (e, t, o) {
        ...
        var r = e("./action/BossShowAction"),
            ...
            h = (u.property, function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t.recycleCb = null, t.spineData = null, t.bossName = null, t.id = null, t.type = null, t.durationTime = 0, t.actionData = null, t.actionScript = null, t.config = null, t.collideBox = null, t.skeleton = null, t.die = !1, t.fishType = null, t.hitPoint = 0, t.onStageRect = !1, t.score = 0, t.directionLeft = !1, t
                }
                var o;
                return n(t, e), o = t, t.prototype.init = function (e, t, n) {
                    var i = s.default.getConfig("boss"),
                        r = s.default.getConfig("fish");
                    this.id = null, this.bossName = e, this.config = i[e], this.spineData = s.default.getSpine(this.config.id), this.recycleCb = n, this.fishType = this.config.id, this.id = t.opt.id, this.hitPoint = t.opt.hp, this.score = 1, this.actionScript = [];
                    for (var a = 0; a < this.config.action.length; a++) { this.actionScript.push(this.config.action[a]); }
                    var c = this.node.getChildByName("_spine");
                    this.skeleton = c.getComponent(sp.Skeleton), this.skeleton.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.skeleton.skeletonData = this.spineData, this.skeleton.animation = "Idle", this.skeleton.loop = !0, this.skeleton.timeScale = .5, this.collideBox = this.node.getComponent(cc.BoxCollider), this.collideBox.offset.x = r[this.fishType].collider.offset.x, this.collideBox.offset.y = r[this.fishType].collider.offset.y, this.collideBox.size.width = r[this.fishType].collider.size.w, this.collideBox.size.height = r[this.fishType].collider.size.h, this.collideBox.tag = this.id[0], this.collideBox.enabled = !1, this.die = !1, this.node.setScale(1), this.node.opacity = 255, this.node.name = "boss", this.node.active = !0, this.isBoat() || this.node.on(o.SWITCH_DIRECTION, this.switchDirection, !0)
                }, t.prototype.switchDirection = function (e, t) {
                    t.node.getChildByName("_spine").getComponent(sp.Skeleton).setAnimation(0, e ? "left" : "right", !0)
                }, t.prototype.isBoat = function () {
                    return this.fishType >= "Fish_03" && this.fishType <= "Fish_05"
                    ...
                    if (this.id.length > 0) {
                        var e = this.id.shift();
                        return this.collideBox.tag = this.id[0], c.default.getInstance().playBossCoinWin(), e
                    }
                    ...
                    this.isBoat() && this.config.showaction == "slowMoveFromBottomToTop" && (this.node.angle = -180), c.default.getInstance().playBossEnter(this.fishType), r.default.runShowAction(this.config.showaction, this.node, this.showTimeOverCallBack)
                }, t.prototype.runToDie = function () {
                    this.die = !0, this.collideBox.enabled = !1, this.enableOnStageRect(!1), this.unschedule(this.cancelAttackShow), this.cancelAttackShow(), this.node.stopAllActions(), r.default.runShowAction("DoDie", this.node, this.dieOverCallBack), c.default.getInstance().playBossCoinWin()
                }, t.prototype.runGetOut = function () {
                    this.die = !0, this.collideBox.enabled = !1, this.enableOnStageRect(!1), this.unschedule(this.cancelAttackShow), this.isBoat() || this.unschedule(this.runDirectionAnimation), this.cancelAttackShow(), this.node.stopAllActions(), this.isBoat() || this.node.off(o.SWITCH_DIRECTION, this.switchDirection, !0), r.default.runShowAction("DoDieFlyOut", this.node, this.dieOverCallBack), c.default.getInstance().playBossFlyOut(this.bossName)
                }, t.prototype.runGetOutWithOutFly = function () {
                    this.die = !0, this.collideBox.enabled = !1, this.enableOnStageRect(!1), this.unschedule(this.cancelAttackShow), this.isBoat() || this.unschedule(this.runDirectionAnimation), this.cancelAttackShow(), this.node.stopAllActions(), this.isBoat() && this.node.off(o.SWITCH_DIRECTION, this.switchDirection, !0), this.dieOverCallBack(this.node)
                }, t.prototype.isDie = function () {
                    return this.die
                }, t.prototype.showTimeOverCallBack = function (e) {
                    var t = e.getComponent(o);
                    t && (cc.log("showTimeOverCallBack"), t.enableColldeState(!0), t.enableOnStageRect(!0), c.default.getInstance().playBossEnter(t.bossName), t.isBoat() || t.schedule(t.runDirectionAnimation, 6, 4, 10))
                }, t.prototype.changeBgRollSpeed = function (e) {
                    l.default.disPatchEvent(l.default.CHANGE_SPEED, e)
                }, t.prototype.runDirectionAnimation = function () {
                    this.directionLeft = !this.directionLeft, this.node.emit(o.SWITCH_DIRECTION, this.directionLeft, this)
                ...
                }, t.prototype.update = function (e) { }, t.prototype.getBossName = function () {
                    return this.bossName
                }, t.prototype.playHitAnimation = function () {
                    if (this.skeleton) {
                        var e = this.skeleton;
                        e.setAnimation(0, "die", !1), e.setCompleteListener(function () {
                            e.setAnimation(0, "Idle", !0)
                        }), this.isBoat() ? c.default.getInstance().playBossBoatLostLife() : c.default.getInstance().playBossPlaneLostLife()
                    }
                    ...
                    return !1
                }, t.SWITCH_DIRECTION = "directon", t = o = i([p], t)
            }(cc.Component));
        o.default = h, cc._RF.pop()
    }, {
        "../../Components/Business/AudioManage": "AudioManage",
        "../../Utils/KAFishGameAssets": "KAFishGameAssets",
        "./AutoScollLayer": "AutoScollLayer",
        "./Bullet": "Bullet",
    ...
    Bullet: [function (e, t, o) {
        ...
        var r = e("../../Utils/CCHelper"),
            ...
            p = (l.property, function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t._bulletType = 0, t._speed = 0, t._angle = 0, t._vx = 0, t._vy = 0, t._ndAnimation = null, t._lockId = null, t._recycleCb = null, t._colliderCb = null, t._isBomb = !1, t._tag = 0, t._isPending = !1, t._enableColliderEvent = !0, t._frameRate = 0, t._selfBullet = !1, t._hideInst = !1, t._isFreeSpin = !1, t
                }
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () { }, t.prototype.init = function (e, t, o, n, i, r, a, s, c, l) {
                    var u = this;
                    this._selfBullet = s, this._speed = n, this._bulletType = a, r ? (this._lockId = r, this.node.name = "lock_" + r, this._frameRate >= 40 ? this._speed = 6500 : this._frameRate < 40 && this._frameRate >= 35 ? this._speed = 5500 : this._speed = 5e3) : (this._lockId = null, this.node.name = "bullet" + e), this._recycleCb = c, this._isPending = !1, this._colliderCb = l, this._isBomb = !1, this._enableColliderEvent = s, this._tag = e;
                    var p = this.node.getChildByName("img");
                    this._ndAnimation = p, this._ndAnimation.active = !0;
                    for (var h = p.getComponent(cc.Animation), f = h.getClips(); f.length > 0;) { h.removeClip(f[0], !0), f = h.getClips(); }
                    var d = i.animats;
                    ["run"].forEach(function (e, t, o) {
                        var n = u.getSpriteFrameList(d[e], e),
                            i = cc.AnimationClip.createWithSpriteFrames(n, d[e].speed);
                        e === "run" && (i.wrapMode = cc.WrapMode.Loop), h.addClip(i, e)
                    }), h.play("run");
                    var _ = this._enableCollider(!0);
                    _.offset.x = i.collider.offset.x, _.offset.y = i.collider.offset.y, _.size.width = i.collider.size.w, _.size.height = i.collider.size.h, _.tag = e, t.y += 40, this.node.active = !0, this.node.position = t, this._angle = o, this._vx = this._getAngleX(this._angle, 1), this._vy = this._getAngleY(this._angle, 1), this.node.angle = 0, this.node.angle = -this._getFilpAngle(this._angle, ""), this._angle = this.node.angle, p.setScale(1)
                    ...
                    enumerable: !0,
                    configurable: !0
                }), Object.defineProperty(t.prototype, "isFreeSpin", {
                    get: function () {
                    ...
                    var e = this;
                    if (!this._isBomb) {
                        this._isBomb = !0, this._ndAnimation.active = !1;
                        var t = this.node.getChildByName("spine"),
                            o = t.getComponent(sp.Skeleton);
                        o.skeletonData = c.default.getSpine("shoot"), o.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), o.animation = "animation", o.loop = !1, o.paused = !1, t.active = !0;
                        var n = this;
                        o.setCompleteListener(function () {
                            t.active = !1;
                            var o = t.getComponent(sp.Skeleton);
                            o.paused = !0, o.skeletonData = null, n.node.active = !1, n._hideInst = !1, n.node.opacity = 255, n._recycleCb && e._recycleCb(n.node)
                        })
                    }
                }, t.prototype.doBomb = function () {
                    this._isBomb || this._playBombAnimation()
    ...
    BusinessStorage: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            s = (r.property, function (e) {
                ...
                var o;
                return n(t, e), o = t, t.isGameStart = function () {
                    return o._startGame
                }, t.getAutoFireState = function () {
                    return o._autoFire
                }, Object.defineProperty(t.prototype, "nowBossName", {
                    get: function () {
                        return o._bossName
                    },
                    set: function (e) {
                    ...
                    enumerable: !0,
                    configurable: !0
                }), Object.defineProperty(t.prototype, "bgReverse", {
                    get: function () {
                        return o._bgReverse
                    },
                    set: function (e) {
                    ...
                    direction: 0,
                    angle: 0
                }, t._autoFire = !1, t._lockTarget = !1, t._lockTargetId = null, t._lockFishType = "", t._bulletQueue = [], t._colliderQueue = [], t._colliderResultQueue = [], t._fishesQueue = [], t._bulletsRefund = [], t._chatMsgQueue = [], t._gameRecallQueue = [], t._changeScene = !1, t._sceneId = 0, t._isRobot = !1, t._battleboss = !1, t._showRecall = !1, t._reacllQueue = [], t._recallCallBack = null, t._maxBetSetLen = 15, t._pingIntervalId = null, t._syncPosIntervalId = null, t._playview = null, t._bossQueue = [], t._bossSoldierQueue = [], t._syncMovePosQueue = {}, t._bossName = null, t._bgReverse = 0, t = o = i([a], t)
            }(cc.Component));
        o.default = s, cc._RF.pop()
    }, {}],
        ...
        var i = cc._decorator,
            ...
            s = function () {
                ...
                return e.getDefaultWSConnectData = function () {
                    ...
                    n.host = o == "ac.kga8.com" ? "pml.kga8.com" : o == "ac.kaga88.com" ? "pml.kaga88.com" : o == "ac.kaifa88.com" ? "pml.kaifa88.com" : o == "acsea.kga8.com" ? "pmlsea.kga8.com" : o == "acsea.kaga88.com" ? "pmlsea.kaga88.com" : o == "acsea.kaifa88.com" ? "pmlsea.kaifa88.com" : o == "aceu.kaga88.com" ? "pmleu.kaga88.com" : o == "acna.kaga88.com" ? "pmlna.kaga88.com" : o == "acaf.kaga88.com" ? "pmlaf.kaga88.com" : o == "acstage.kga8.com" ? "pmlstage.kga8.com" : o == "acstage.kaga88.com" ? "pmlstage.kaga88.com" : o == "acstage.kaifa88.com" ? "pmlstage.kaifa88.com" : o == "actest.kaga88.com" ? "rmptest.kaga88.com" : o === "localhost:7456" ? "localhost:3080" : o === "10.10.2.165:7456" ? "rmptest.kaga88.com" : o;
                    return n.gamePath = "/kaga/fish/AirCombat1942", n.host = (t.protocol == "http:" ? "ws" : "wss") + "://" + n.host, cc.log("host=", n.host, "gamePath", n.gamePath), n
                }, e = n([r], e)
            }();
        o.default = s, cc._RF.pop()
    }, {
        ...
        var r = e("../../Utils/CCHelper"),
            ...
            u = (c.property, function (e) {
                ...
                return n(t, e), t.prototype.init = function (e, t, o) {
                    ...
                    l.string = t, l._updateRenderData(!0), u.string = o, u._updateRenderData(!0), p.spriteFrame = a.default.getSpriteFrame("currencysymbol", "reelwinmeter_" + r.default.getRealSpriteCurrency(e)), h.spriteFrame = a.default.getSpriteFrame("currencysymbol", "reelwinmeter_" + r.default.getRealSpriteCurrency(e)), cc.log(e), r.default.getRealSpriteCurrency(e) == "\xa5" ? (s.setScale(.75), c.setScale(.75)) : r.default.getRealSpriteCurrency(e) == "$" ? (s.setScale(.6), c.setScale(.6)) : r.default.getRealSpriteCurrency(e) == "\u20bd" ? (s.setScale(.75), c.setScale(.75)) : r.default.getRealSpriteCurrency(e) == "\u20ac" ? (s.setScale(.75), c.setScale(.75)) : r.default.getRealSpriteCurrency(e) == "\u20ba" ? (s.setScale(.75), c.setScale(.75)) : (s.setScale(1), c.setScale(1))
                    ...
                    var o = this.node.getChildByName("_minbet"),
                        ...
                        c = i.scale * i.width;
                    s.default.walletInfo.currencySymbolInBack ? (a.position = cc.v2(t.x, t.y + 8), i.position = cc.v2(a.position.x - a.width / 2 - c / 2 + t.x - 10, t.y + 5), o.position = cc.v2(i.position.x - o.width / 2 - c / 2 + t.x, t.y + 8), n.position = cc.v2(a.position.x + a.width / 2 + n.width / 2 + t.x, t.y + 8), r.position = cc.v2(n.position.x + n.width / 2 + c / 2 + t.x + 15, t.y + 5)) : (a.position = cc.v2(t.x, t.y + 8), o.position = cc.v2(a.position.x - a.width / 2 - o.width / 2 + t.x, t.y + 8), i.position = cc.v2(o.position.x - o.width / 2 - c / 2 + t.x, t.y + 5), r.position = cc.v2(a.position.x + a.width / 2 + c / 2 + t.x + 0, t.y + 5), n.position = cc.v2(r.position.x + c / 2 + n.width / 2 + t.x + 10, t.y + 8))
                }, t = i([l], t)
            }(cc.Component));
        o.default = u, cc._RF.pop()
    }, {
            ...
            h = (u.property, function (e) {
                ...
                return n(t, e), t.prototype.onLoad = function () { }, t.prototype.isOnStage = function () {
                    ...
                    if (e.state == r.default.consts.FLOCK) {
                        var u = e.path.split("|");
                        l = c.default.getConfig("groupPath")[u[1]], u[0] == "flock_id_0" && (i = !0)
                    ...
                    this.skeleton = h.getComponent(sp.Skeleton), this.skeleton.skeletonData = c.default.getSpine(e.type), this.skeleton.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), this.skeleton.animation = this.aniConfig.run.animation, this.skeleton.loop = this.aniConfig.run.repeat, this.skeleton.paused = !1, h.scale != this.aniConfig.run.scale && h.setScale(this.aniConfig.run.scale);
                    var f = [];
                    for (var d in l) {
                        f.push({
                            x: l[d].x + t.x,
                    ...
                    if (!this._isDie) {
                        ...
                        this.node.runAction(cc.sequence(cc.fadeOut(1), cc.callFunc(function () {
                            t._isDie = !0, t._portrait = !1, t.node.active = !1, t.node.getChildByName("_spine").angle = 0, t.skeleton.paused = !0, t.skeleton = null, t._recycleCb && t._recycleCb(e.node)
                        })))
                    }
                }, t.prototype.doDie = function () {
                    var e = this;
                    if (!this._isDie && this.collideBox.enabled) {
                        this._isDie = !0, this.enableCollider(!1), this.unschedule(this.cancelAttackShow), this.cancelAttackShow(), l.default.getInstance().playEnemyDie(this._fishType);
                        var t = this;
                        this.aniConfig.dead.type != "none" ? (this.skeleton.animation = this.aniConfig.dead.animation, this.skeleton.loop = !1, this.skeleton.paused = !0, this.skeleton = null, this.node.runAction(cc.sequence(cc.fadeOut(.05), cc.callFunc(function () {
                            t.node.active = !1, t._portrait = !1, t.node.getChildByName("_spine").angle = 0, t._recycleCb && t._recycleCb(e.node)
                        })))) : (this.skeleton.loop = !1, this.skeleton.paused = !0, this.skeleton = null, this.node.runAction(cc.sequence(cc.fadeOut(.05), cc.callFunc(function () {
                    ...
                    if (!this._isDie) {
                        if (this._pauseTime - e > 0) { this._pauseTime -= e; }
                            ...
                            if (this._alive -= e, this._runTime += e * this._rate, this._bezier != null) {
                                ...
                                if (n) {
                                    this.node.position = n, this.updateDegree();
                    ...
                    if (this._lastPosition) {
                        ...
                        if (!(this._lastPosition.sub(e).mag() < 1)) {
                            var t;
                            e.x - this._lastPosition.x == 0 ? e.y - this._lastPosition.y > 0 ? (t = -90, !0) : (t = 90, !1) : (t = 180 * -Math.atan((e.y - this._lastPosition.y) / (e.x - this._lastPosition.x)) / 3.14, e.x < this._lastPosition.x ? (t += 180, !1) : !0), this._portrait ? this.node.angle = 0 : this.node.angle = -(t + 90), this._lastPosition = e
                        }
                    ...
                    return this._fishType >= "Fish_00" && this._fishType <= "Fish_02"
                }, t.prototype.isBoat = function () {
                    return this._fishType == "Fish_10" || this._fishType == "Fish_11" || this._fishType == "Fish_13" || this._fishType == "Fish_14" || this._fishType == "Fish_18" || this._fishType == ""
                }, t = i([p], t)
            }(cc.Component));
        o.default = h, cc._RF.pop()
    }, {
        ...
        var r = cc._decorator,
            ...
            d = function (e) {
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    this.clearRow(o), this.init(this._businessStorage.recallCallBack);
                    var n = e.target,
                        i = n.scaleX;
                    n.runAction(cc.sequence(cc.scaleTo(.05, .9 * i, .9), cc.scaleTo(.05, i, 1))), u.default.getInstance().playBtnEffect()
        ...
        var r = e("../../Utils/KAFishGameAssets"),
            ...
            l = function (e) {
                ...
                return n(t, e), t.prototype.init = function () {
                    ...
                    n.spriteFrame = i, t.position = o.position, e >= "Fish_09" && e <= "Fish_16" ? t.setScale(.3) : e >= "Fish_03" && e <= "Fish_05" ? t.setScale(.1) : e >= "Fish_06" && e <= "Fish_08" ? t.setScale(.3) : t.setScale(.5), this.lockFramePosBackToDefault()
    ...
    KAFishGameAssets: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            l = function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t.spineData = [], t.spriteAtlaseData = [], t.spriteframes = [], t.pfbsData = [], t
                }
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    ...
                    for (var e = 0; e < this.spineData.length; e++) { this.spineData[e] && (o._spine[this.spineData[e].name] = this.spineData[e], o._spineNodePool[this.spineData[e].name] = new cc.NodePool); }
                    for (e = 0; e < this.spriteAtlaseData.length; e++) { this.spineData[e] && (o._sprite[this.spriteAtlaseData[e].name] = this.spriteAtlaseData[e]); }
                    for (e = 0; e < this.pfbsData.length; e++) { this.spineData[e] && (o._prefab[this.pfbsData[e].name] = this.pfbsData[e], o._pfbNodePool[this.pfbsData[e].name] = new cc.NodePool); }
                    for (e = 0; e < this.spriteframes.length; e++) { this.spineData[e] && (o._spriteFrame[this.spriteframes[e].name] = this.spriteframes[e]) }
                    ...
                    return i
                }, t.getSpriteFrameNotAtlas = function (e) {
                    return o._spriteFrame[e]
                ...
                }, t._bulletConfig = {}, t._fishConfig = {}, t._pathConfig = {}, t._groupConfig = {}, t._groupPathConfig = {}, t._flockConfig = {}, t._bossConfig = {}, t._spine = {}, t._sprite = {}, t._prefab = {}, t._spriteFrame = {}, t._pfbNodePool = {}, t._spineNodePool = {}, i([s({
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    h.default.isAutoSearchTable() && (this.node.getChildByName("_roomoption").active = !1, this.scheduleOnce(function (e) {
                        if (this._tableSearchStorage) {
                            var t = {};
                            t.level = h.default.getUrlRoomLevel(), this._tableSearchStorage.searchParams = t, this._tableSearchStorage.startSearch = !0
                        }
                    }, 1));
                    ...
                    if (this._userInfoStorage && this._userInfoStorage.roomlevelCost && !this._hasInitRoom) {
                        ...
                        for (var t = this.node.getChildByName("_roomoption"), o = 0; o < u.default.consts.MAX_ROOM; o++) {
                            ...
                            r.setParent(n), r.name = "room_currency_" + o, a.init(i[0].cy, y.default.numberFormat(i[0].rmp), y.default.numberFormat(i[i.length - 1].rmp)), a.setSeparate("-")
                        }
                    ...
                    if (!this._initLabelPos) {
                        ...
                        for (var e = [-141, -141, -241], t = this.node.getChildByName("_roomoption"), o = 0; o < u.default.consts.MAX_ROOM; o++) {
                            var n = t.getChildByName("_room" + o),
                                i = this._currenyLabelPoole[o];
                            i.getComponent(_.default).show(n.position, cc.v2(0, e[o])), i.x -= 100, i.y -= 8
                        }
                    }
            ...
            u = function (e) {
                ...
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    ...
                    if (t) {
                        ...
                        l.default.isZhHant() ? n.spriteFrame = this.loadAtlas.getSpriteFrame("loading_hant") : l.default.isZhHans() && (n.spriteFrame = this.loadAtlas.getSpriteFrame("loading_hans"))
                    }
                    this.node.on("loadScene", this.LoadScene, this), o._instance = this
                }, t.startToLoadScene = function () {
                    o._instance.node.emit("loadScene")
                    ...
                    var e = o._instance;
                    e._userInfoStorage && e._userInfoStorage.isLogin && this.loadGameScene(e._progressBar)
                }, t.prototype.update = function (e) { }, t._instance = null, i([s], t.prototype, "sceneName", void 0), i([s({
                    type: cc.SpriteAtlas
                })], t.prototype, "loadAtlas", void 0), t = o = i([a], t)
            }(cc.Component);
        o.default = u, cc._RF.pop()
    }, {
        "../../Utils/CCHelper": "CCHelper",
            ...
            c = function (e) {
                ...
                return n(t, e), t.prototype.play = function () {
                    ...
                    this.unscheduleAllCallbacks(), this.node.runAction(cc.sequence(cc.fadeOut(.5), cc.callFunc(function () {
                        cc.log("novice close"), e.node.active = !1
                    })))
                }, t = i([a], t)
            }(cc.Component);
        o.default = c, cc._RF.pop()
    ...
    PayTableFishFrame: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            l = function (e) {
                ...
                return n(t, e), t.prototype.init = function (e, t, o) {
                    this.node.getChildByName("_separate");
                    var n = null;
                    o ? ((n = this.node.getChildByName("_fish").getComponent(sp.Skeleton)).skeletonData = s.default.getSpine(e), cc.log(e, n.findAnimation("Idle")), n.animation = n.findAnimation("Idle") ? "Idle" : "animation", n.setAnimationCacheMode(sp.Skeleton.AnimationCacheMode.SHARED_CACHE), n.loop = !0, this.node.getChildByName("_fish").setScale(.1), this.node.getChildByName("_sprite").active = !1) : ((n = this.node.getChildByName("_sprite").getComponent(cc.Sprite)).spriteFrame = s.default.getSpriteFrame("fish_alpha_sheet", e), this.node.getChildByName("_fish").active = !1);
                    var i = cc.instantiate(s.default.getPrefab("PTPayScoreLabel"));
                    if (i.name = "score", i.setParent(this.node), i.getComponent(c.default).init(t), n.spriteFrame) { i.setPosition(cc.v2(0, -n.spriteFrame.getRect().height / 2 - 30)); }
                    else {
                        var r = this.node.getChildByName("bg"),
                            a = this.node.getChildByName("_fish");
                        i.setPosition(cc.v2(a.x, r.y - r.height / 2 - 30))
                    }
                }, t.prototype.setScale = function (e) {
                    this.node.getChildByName("_fish").active ? this.node.getChildByName("_fish").setScale(e) : this.node.getChildByName("_sprite").setScale(e)
                }, t.prototype.enableBg = function (e) {
                    this.node.getChildByName("bg").active = e
                }, t = i([a], t)
            }(cc.Component);
        o.default = l, cc._RF.pop()
    }, {
        ...
        var r = cc._decorator,
            ...
            _ = function (e) {
                ...
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    ...
                    this._paytableStorage.pageIdx + t > this._pageViews.length ? this._paytableStorage.pageIdx = 1 : this._paytableStorage.pageIdx + t < 0 ? this._paytableStorage.pageIdx = this._pageViews.length : this._paytableStorage.pageIdx += t, this._paytableStorage.pageIdx == 0 && (this._paytableStorage.pageIdx = this._pageViews.length);
                    var o = e.target,
                        n = o.scaleX;
                    o.runAction(cc.sequence(cc.scaleTo(.05, .9 * n, .9), cc.scaleTo(.05, n, 1))), f.default.getInstance().playBtnEffect()
                    ...
                    var t = e.getChildByName("_boss"),
                        ...
                        i = e.getChildByName("_unclear"),
                        r = e.getChildByName("_freespin");
                    ...
                    t.setParent(o._self.node), t.name = o.PFB_ICON_NAME + "3", t.x = -260, t.y = 160;
                    var n = t.getComponent(u.default);
                    n.init("Fish_" + c.default.paddingZeroLeft("3", 2), o._self.getPayRealMoney("3"), !1), n.setScale(1), n.enableBg(!1);
                    var i = o._self.getPTFrame();
                    i.setParent(o._self.node), i.name = o.PFB_ICON_NAME + "4", i.x = t.x + t.width + i.width + 20, i.y = 160;
                    var r = i.getComponent(u.default);
                    r.init("Fish_" + c.default.paddingZeroLeft("4", 2), o._self.getPayRealMoney("4"), !1), r.setScale(1), r.enableBg(!1);
                    var a = o._self.getPTFrame();
                    a.setParent(o._self.node), a.name = o.PFB_ICON_NAME + "5", a.x = i.x + i.width + a.width + 20, a.y = 160;
                    var s = a.getComponent(u.default);
                    s.init("Fish_" + c.default.paddingZeroLeft("5", 2), o._self.getPayRealMoney("5"), !1), s.setScale(1), s.enableBg(!1);
                    var l = e.getChildByName("_boss");
                    l.active = !0, l.setPosition(cc.v2(0, -640)), e.runAction(cc.fadeIn(1))
                }, t.prototype.createPage2 = function () {
                    o._self.closePage();
                    var e = o._self._fishNode.getChildByName("_page1");
                    e.active = !0;
                    var t = o._self.getPTFrame();
                    t.setParent(o._self.node), t.name = o.PFB_ICON_NAME + "6", t.x = 0, t.y += 520;
                    var n = t.getComponent(u.default);
                    n.init("Fish_" + c.default.paddingZeroLeft("6", 2), o._self.getPayRealMoney("6"), !1), n.setScale(1), n.enableBg(!1);
                    var i = o._self.getPTFrame();
                    i.setParent(o._self.node), i.name = o.PFB_ICON_NAME + "7", i.x = -280, i.y += t.y - 520 + 100;
                    var r = i.getComponent(u.default);
                    r.init("Fish_" + c.default.paddingZeroLeft("7", 2), o._self.getPayRealMoney("7"), !1), r.setScale(1), r.enableBg(!1);
                    var a = o._self.getPTFrame();
                    a.setParent(o._self.node), a.name = o.PFB_ICON_NAME + "8", a.x += 280, a.y += t.y - 520 + 100;
                    var s = a.getComponent(u.default);
                    s.init("Fish_" + c.default.paddingZeroLeft("8", 2), o._self.getPayRealMoney("8"), !1), s.setScale(1), s.enableBg(!1);
                    var l = e.getChildByName("_boss");
                    ...
                    var e = o._self._fishNode.getChildByName("_page1");
                    e.active = !0;
                    var t = e.getChildByName("_speedup"),
                        n = e.getChildByName("_unclear"),
                        i = e.getChildByName("_freespin");
                    t.active = !0, n.active = !0, i.active = !0;
                    var r = o._self.getPTFrame();
                    r.setParent(o._self.node), r.name = o.PFB_ICON_NAME + "0", r.x += -250, r.y += 515;
                    var a = r.getComponent(u.default);
                    a.init("Fish_" + c.default.paddingZeroLeft("0", 2), o._self.getPayRealMoney("0"), !0), a.setScale(1), a.enableBg(!1), n.setPosition(cc.v2(160, r.y - 140));
                    var s = o._self.getPTFrame();
                    s.setParent(o._self.node), s.name = o.PFB_ICON_NAME + "1", s.x += -250, s.y += r.y - 480;
                    var l = s.getComponent(u.default);
                    l.init("Fish_" + c.default.paddingZeroLeft("1", 2), o._self.getPayRealMoney("1"), !0), l.setScale(1), l.enableBg(!1), i.setPosition(cc.v2(160, s.y - 70));
                    var p = o._self.getPTFrame();
                    p.setParent(o._self.node), p.name = o.PFB_ICON_NAME + "2", p.x += -250, p.y += s.y - 480;
                    var h = p.getComponent(u.default);
                    h.init("Fish_" + c.default.paddingZeroLeft("2", 2), o._self.getPayRealMoney("2"), !0), h.setScale(1), h.enableBg(!1), t.setPosition(cc.v2(160, p.y - 150)), e.runAction(cc.fadeIn(1))
                    ...
                    var n = t.getComponent(u.default);
                    n.init("Fish_" + c.default.paddingZeroLeft("9", 2), o._self.getPayRealMoney("9"), !0), n.setScale(.4);
                    var i = o._self.getPTFrame();
                    i.setParent(o._self.node), i.name = o.PFB_ICON_NAME + "10", i.x += -200, i.y += t.y - 380;
                    var r = i.getComponent(u.default);
                    r.init("Fish_" + c.default.paddingZeroLeft("10", 2), o._self.getPayRealMoney("10"), !0), r.setScale(.3);
                    var a = o._self.getPTFrame();
                    a.setParent(o._self.node), a.name = o.PFB_ICON_NAME + "11", a.x += -200, a.y += i.y - 380;
                    var s = a.getComponent(u.default);
                    s.init("Fish_" + c.default.paddingZeroLeft("11", 2), o._self.getPayRealMoney("11"), !0), s.setScale(.4);
                    ...
                    p.init("Fish_" + c.default.paddingZeroLeft("12", 2), o._self.getPayRealMoney("12"), !0), p.setScale(.5);
                    var h = o._self.getPTFrame();
                    h.setParent(o._self.node), h.name = o.PFB_ICON_NAME + "13", h.x += 205, h.y += 600;
                    var f = h.getComponent(u.default);
                    f.init("Fish_" + c.default.paddingZeroLeft("13", 2), o._self.getPayRealMoney("13"), !0), f.setScale(.3);
                    ...
                    _.init("Fish_" + c.default.paddingZeroLeft("14", 2), o._self.getPayRealMoney("14"), !0), _.setScale(.4);
                    ...
                    y.init("Fish_" + c.default.paddingZeroLeft("15", 2), o._self.getPayRealMoney("15"), !0), y.setScale(.4);
                    ...
                    v.init("Fish_" + c.default.paddingZeroLeft("16", 2), o._self.getPayRealMoney("16"), !0), v.setScale(.4), e.runAction(cc.fadeIn(1))
                    ...
                    var n = t.getComponent(u.default);
                    n.init("Fish_" + c.default.paddingZeroLeft("17", 2), o._self.getPayRealMoney("17"), !0), n.setScale(.4);
                    var i = o._self.getPTFrame();
                    i.setParent(o._self.node), i.name = o.PFB_ICON_NAME + "18", i.x += -200, i.y += t.y - 380;
                    var r = i.getComponent(u.default);
                    r.init("Fish_" + c.default.paddingZeroLeft("18", 2), o._self.getPayRealMoney("18"), !0), r.setScale(.5);
                    var a = o._self.getPTFrame();
                    a.setParent(o._self.node), a.name = o.PFB_ICON_NAME + "19", a.x += -200, a.y += i.y - 380;
                    var s = a.getComponent(u.default);
                    s.init("Fish_" + c.default.paddingZeroLeft("19", 2), o._self.getPayRealMoney("19"), !0), s.setScale(1);
                    var l = o._self.getPTFrame();
                    l.setParent(o._self.node), l.name = o.PFB_ICON_NAME + "20", l.x += -200, l.y += a.y - 380;
                    var p = l.getComponent(u.default);
                    p.init("Fish_" + c.default.paddingZeroLeft("20", 2), o._self.getPayRealMoney("20"), !0), p.setScale(.5);
                    var h = o._self.getPTFrame();
                    h.setParent(o._self.node), h.name = o.PFB_ICON_NAME + "21", h.x += 205, h.y += 600;
                    var f = h.getComponent(u.default);
                    f.init("Fish_" + c.default.paddingZeroLeft("21", 2), o._self.getPayRealMoney("21"), !0), f.setScale(.6);
                    var d = o._self.getPTFrame();
                    d.setParent(o._self.node), d.name = o.PFB_ICON_NAME + "22", d.x += 205, d.y += h.y - 380;
                    var _ = d.getComponent(u.default);
                    _.init("Fish_" + c.default.paddingZeroLeft("22", 2), o._self.getPayRealMoney("22"), !0), _.setScale(.6);
                    var g = o._self.getPTFrame();
                    g.setParent(o._self.node), g.name = o.PFB_ICON_NAME + "23", g.x += 205, g.y += d.y - 380;
                    var y = g.getComponent(u.default);
                    y.init("Fish_" + c.default.paddingZeroLeft("23", 2), o._self.getPayRealMoney("23"), !0), y.setScale(.6);
                    var m = o._self.getPTFrame();
                    m.setParent(o._self.node), m.name = o.PFB_ICON_NAME + "24", m.x += 205, m.y += g.y - 380;
                    var v = m.getComponent(u.default);
                    v.init("Fish_" + c.default.paddingZeroLeft("24", 2), o._self.getPayRealMoney("24"), !0), v.setScale(.5), e.runAction(cc.fadeIn(1))
                }, t.prototype.createPage6 = function () {
                    o._self.closePage();
                    var e = o._self._fishNode.getChildByName("_page1");
                    e.active = !0;
                    var t = o._self.getPTFrame();
                    t.setParent(o._self.node), t.name = o.PFB_ICON_NAME + "25", t.x += -200, t.y += 600;
                    var n = t.getComponent(u.default);
                    n.init("Fish_" + c.default.paddingZeroLeft("25", 2), o._self.getPayRealMoney("25"), !0), n.setScale(.8);
                    var i = o._self.getPTFrame();
                    i.setParent(o._self.node), i.name = o.PFB_ICON_NAME + "26", i.x += -200, i.y += t.y - 380;
                    var r = i.getComponent(u.default);
                    r.init("Fish_" + c.default.paddingZeroLeft("26", 2), o._self.getPayRealMoney("26"), !0), r.setScale(.8);
                    var a = o._self.getPTFrame();
                    a.setParent(o._self.node), a.name = o.PFB_ICON_NAME + "27", a.x += -200, a.y += i.y - 380;
                    var s = a.getComponent(u.default);
                    s.init("Fish_" + c.default.paddingZeroLeft("27", 2), o._self.getPayRealMoney("27"), !0), s.setScale(1);
                    var l = o._self.getPTFrame();
                    l.setParent(o._self.node), l.name = o.PFB_ICON_NAME + "28", l.x += -200, l.y += a.y - 380;
                    var p = l.getComponent(u.default);
                    p.init("Fish_" + c.default.paddingZeroLeft("28", 2), o._self.getPayRealMoney("28"), !0), p.setScale(.6);
                    var h = o._self.getPTFrame();
                    h.setParent(o._self.node), h.name = o.PFB_ICON_NAME + "29", h.x += 205, h.y += 600;
                    var f = h.getComponent(u.default);
                    f.init("Fish_" + c.default.paddingZeroLeft("29", 2), o._self.getPayRealMoney("29"), !0), f.setScale(1), e.runAction(cc.fadeIn(1))
                }, t._self = null, t.MAX_FISH_TYPE = 30, t.PFB_ICON_NAME = "fishicon", t = o = i([a], t)
            }(s.default);
    ...
    PlayViewControl: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            A = e("../Components/Model/PromptDialogStorage"),
            T = e("../Components/Model/PngStorage"),
            w = e("LanguageData"),
            O = e("../Utils/RealMoneyPlatform"),
            R = e("../Components/Model/PayTableViewStorage"),
            E = e("../Components/UI/AnimationBonus"),
            I = e("../Components/UI/AnimationOnlyCoin"),
            F = e("../Components/UI/RecallRow"),
            k = e("../Components/UI/AndroidAskFullScreen"),
            B = e("../Components/Business/StartSearchTableForPlayView"),
            x = e("../Components/UI/GunSight"),
            N = e("../Components/UI/CurrencyLabel"),
            M = e("../Components/UI/BossNotify"),
            L = e("../Components/UI/AnimationBingo"),
            D = e("../Components/UI/NoviceTeaching"),
            j = e("../Components/UI/AutoScollLayer"),
            ...
            K = e("../Components/UI/WebViewGameRecall"),
            $ = e("../Components/UI/AnimationEnemyDieBoom"),
            Q = function (e) {
                function t() {
                    var t = e !== null && e.apply(this, arguments) || this;
                    return t._hideStarttime = 0, t._hideStacktime = 0, t._isHideDrop = !1, t._hideDrawCount = 0, t._businessStorage = null, t._userInfo = null, t._netConnector = null, t._tableSearchStorage = null, t._walletStorage = null, t._paytableStorage = null, t._ping = null, t._isShow = !1, t._isPending = !1, t._isCancelLock = !1, t._shootDelay = 0, t._spaceShootDelay = 0, t._ndEnemyPool = null, t._ndBulletPool = null, t._screenJoyStick = null, t._animationPause = null, t._bingoAnim = null, t._airCraiftManager = null, t._bossWarning = null, t._fishesNodeCacheMap = {}, t._bulletsNodeCacheMap = {}, t._btnQuitClick = !1, t._showcounter = !1, t._scrollbarPos = null, t._scrollState = !1, t._scrollAction = !1, t._frameRateTime = 0, t._tideStopFire = !1, t._isShake = !1, t._isFreeGameAutoFire = !1, t
                }
                var o;
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    o._instance = this;
                    var e = h.default.urlParse();
                    e && e.showfps ? this._showcounter = !0 : this._showcounter = !1, cc.director.getCollisionManager().enabled = !0, this._businessStorage = this.node.getComponent(c.default), this._userInfo = this.node.getComponent(l.default), this._netConnector = this.node.getComponent(u.default), this._tableSearchStorage = this.node.getComponent(f.default), this._walletStorage = this.node.getComponent(P.default), this._ping = this.node.getComponent(T.default), this._paytableStorage = this.node.getComponent(R.default), this._airCraiftManager = new H.default, this._airCraiftManager.init(this._$._ndTouchScreen), O.default.walletInfo = this.node.getComponent(P.default);
                    var t, n = this._$._ndJoyStick,
                        i = this._$._ndScreenCtrl,
                        r = new cc.Component.EventHandler;
                    (r.target = this.node, r.component = "PlayViewControl", r.handler = "onJoyStickMove", r.customEventData = "", n) && ((t = n.getComponent(_.Joystick)) && (t.moveEvents = [], t.moveEvents.push(r)));
                    i && ((t = i.getComponent(_.Joystick)) && (this._screenJoyStick = t, t.moveEvents = [], t.moveEvents.push(r)));
                    this._$._ndBulletPool && (this._ndBulletPool = this._$._ndBulletPool), this._$._ndEnemyContainer && (this._ndEnemyPool = this._$._ndEnemyContainer), $.default.setContainer(this._ndEnemyPool), c.default._playview = this, this._$._locktouchScreen.active = !1, this._showHideChildren(!1), this._initComponentvent()
                }, t.prototype._initComponentvent = function () {
                    var e = this;
                    ...
                    var t = this._scrollbar.getChildByName("_btnlayout"),
                        n = h.default.urlParse(),
                        i = n.nf;
                    if (cc.sys.os == cc.sys.OS_IOS || cc.sys.os == cc.sys.OS_OSX) {
                        if (t) {
                            (c = t.getChildByName("_resize")).active = !1;
                            var r = t.getChildByName("_recall");
                            h.default.isFreePlay() ? r.active = !1 : (r.active = !0, r.on(cc.Node.EventType.TOUCH_END, this._onBtnRecallClick, this, !0));
                            var a = t.getChildByName("_btnQuit"),
                                s = t.getChildByName("_btnPromote");
                            n.l == "-2" || n.l == "-1" ? (a.active = !1, h.default.isShowReCommendGames() && (s.active = !0, s.on(cc.Node.EventType.TOUCH_END, this._onBtnRecommendGameClick, this, !0))) : a.on(cc.Node.EventType.TOUCH_END, this._onBtnQuitClick, this, !0)
                        }
                    } else if (t) {
                        var c = t.getChildByName("_resize");
                        i && i == 1 ? c.active = !1 : (c.active = !0, c.on(cc.Node.EventType.TOUCH_END, this._onBtnResizeClick, this, !0));
                        r = t.getChildByName("_recall");
                        h.default.isFreePlay() ? r.active = !1 : (r.active = !0, r.on(cc.Node.EventType.TOUCH_END, this._onBtnRecallClick, this, !0));
                        a = t.getChildByName("_btnQuit"), s = t.getChildByName("_btnPromote");
                        n.l == "-2" || n.l == "-1" ? (a.active = !1, h.default.isShowReCommendGames() && (s.active = !0, s.on(cc.Node.EventType.TOUCH_END, this._onBtnRecommendGameClick, this, !0))) : a.on(cc.Node.EventType.TOUCH_END, this._onBtnQuitClick, this, !0)
                    }
                    if (cc.systemEvent.on(cc.SystemEvent.EventType.KEY_DOWN, this._systemKeyBoardHandle, this), cc.game.on(cc.game.EVENT_SHOW, function (t) {
                        if (e._netConnector.socketConnector) {
                            if (e._hideStacktime >= o.HIDE_WAIT_INITBG) {
                                var n = e._$._ndFishpondBg.getComponent(j.default);
                                if (n) {
                                    var i = e.node.getChildByName("_ndFishpondBg").getChildByName("_bg1"),
                                        r = e.node.getChildByName("_ndFishpondBg").getChildByName("_bg2");
                                    i.y = 0, r.y = 1920, n.init(j.default.DIRECTION_Y, p.default.consts.BG_SCOLL_SPEED, e._businessStorage.sceneId, e._businessStorage.bgReverse, !1)
                                }
                            }
                            e._hideStarttime = 0, e._hideStacktime = 0, e._isHideDrop = !1, e._hideDrawCount = 0
                        } else { window.location.href = ""; }
                        var a = e._$._btnSound.getComponent(cc.Toggle);
                        a.isChecked && a.uncheck(), b.default.getInstance().disableMusic(!1), b.default.getInstance().disableEffect(!1), cc.log("emit cc.game.EVENT_SHOW!")
                        ...
                        l = t.getChildByName("_changeroomlevel"), u = this._$._selectRoomLevel.getChildByName("_closebtn"), f = this._$._selectRoomLevel.getChildByName("_roomoption");
                        l.active = !1, f.active = !1, u.active = !1
                    } else {
                        var l, u;
                        (l = t.getChildByName("_changeroomlevel")).on(cc.Node.EventType.TOUCH_END, function (e) {
                        ...
                        }, this, !0), (u = this._$._selectRoomLevel.getChildByName("_closebtn")).on(cc.Node.EventType.TOUCH_END, function (e) {
                            this._$._selectRoomLevel.active = !1, b.default.getInstance().playBtnEffect()
                        }, this, !0);
                        for (var f = this._$._selectRoomLevel.getChildByName("_roomoption"), d = 0; d < p.default.consts.MAX_ROOM; d++) {
                            var _ = f.getChildByName("_room" + d);
                            _.getComponent(B.default).init(this._onChangeRoomLevelClickfunction, this._userInfo.roomlevelCost, d);
                            var g = h.default.getMyCannonCostList(this._userInfo.roomlevelCost, d),
                                y = cc.instantiate(z.default.getPrefab("CurrencyLabel")),
                                m = y.getComponent(N.default);
                            y.setParent(_), y.name = "room_currency_" + d, m.init(g[0].cy, O.default.numberFormat(g[0].rmp), O.default.numberFormat(g[g.length - 1].rmp)), m.setSeparate("-"), y.x += -20, y.y += 68
                        }
                        h.default.checkAndSetFrameScale(this._$._selectRoomLevel)
                    }
                    this._$._ndGunsight.getComponent(x.default).init(), this._bingoAnim = cc.instantiate(z.default.getPrefab("animBingo")), this._bingoAnim.active = !1, this._bossWarning = cc.instantiate(z.default.getPrefab("BossWarning")), this._bossWarning.setParent(this._$._ndScreenCtrl), this._bossWarning.setPosition(cc.v2(0, 900)), this._bossWarning.active = !1, this.node.on(o.AUTOFIRE_START, this.onStartAutoFire, this, !0), this.node.on(o.AUTOFIRE_STOP, this.onStopAutoFire, this, !0)
                }, t.disPatchEvent = function (e, t) {
                    o._instance.node.emit(e, t)
                ...
                }, t.prototype.onStartAutoFire = function (e, t) {
                    this._businessStorage.autoFire || (this._setAutoFireStatus(!1), this._businessStorage.autoFire = !0)
                }, t.prototype.onStopAutoFire = function (e, t) {
                    if (this._businessStorage.autoFire) {
                        var o = this._airCraiftManager.getAirCraft(this._userInfo.playerId).getComponent(U.default);
                        o && o.isFreeSpin() ? cc.log("on free spin cancel close auto fire") : (this._closeAutoFire(!1), this._businessStorage.autoFire = !1)
                    }
                    ...
                    if (c.default._playview._netConnector.socketConnector) {
                        ...
                        var o = e.target.getComponent(B.default),
                        ...
                        c.default._playview._netConnector.socketConnector.request(p.default.pomeloRoute.leaveTable, u.default.makeWsPacket({}), function (e) {
                            if (cc.log("leaveTable res:", e), !e || e.err) { cc.log("leaveTable error ", e); }
                                ...
                                n._animationPause && n._animationPause.stop(), n._fishesNodeCacheMap = {}, n._bulletsNodeCacheMap = {}, n._businessStorage.popFishes(), n._businessStorage.popBosses(), n._businessStorage.popBullet(), n._businessStorage.popBossSoldier(), n._airCraiftManager.leave(n._userInfo.playerId), n.node.stopAllActions();
                                var t = {};
                                t[o.searchParams[0].key] = parseInt(o.searchParams[0].value), n._businessStorage.startGame = !1, n._tableSearchStorage.searchParams = t, n._tableSearchStorage.startSearch = !0, n._tableSearchStorage.doSearching = !0, n._tableSearchStorage.changeRoom = !0, j.default.disPatchEvent(j.default.PAUSE, !1), n._onBtnScrolbarClick(null)
                            }
                        })
                    }
                }, t.prototype._onBtnQuitClick = function (e) {
                    b.default.getInstance().playBtnEffect(), this._isCancelLock = !0, this._businessStorage.lockTarget = !1, this._businessStorage.lockTargetId = null, this._businessStorage.lockFishType = "", this._$._locktouchScreen.off(cc.Node.EventType.TOUCH_END, this), this._$._locktouchScreen.active = !1, this._$._lockboard.active = !1, this._closeLockTarget(), o.disPatchEvent(o.AUTOFIRE_STOP, null), h.default.urlParse().l != "-1" && A.default.showAskLogOut(), e.target.runAction(cc.sequence(cc.scaleTo(.05, .9), cc.scaleTo(.05, 1)))
                }, t.prototype._onBtnRecommendGameClick = function (e) {
                    b.default.getInstance().playBtnEffect(), this._isCancelLock = !0, this._businessStorage.lockTarget = !1, this._businessStorage.lockTargetId = null, this._businessStorage.lockFishType = "", this._$._locktouchScreen.off(cc.Node.EventType.TOUCH_END, this), this._$._locktouchScreen.active = !1, this._$._lockboard.active = !1, this._closeLockTarget(), o.disPatchEvent(o.AUTOFIRE_STOP, null), h.default.isShowReCommendGames() && A.default.showRecommendGame(), e.target.runAction(cc.sequence(cc.scaleTo(.05, .9), cc.scaleTo(.05, 1)))
                    ...
                    if (!this._scrollAction) {
                        ...
                        this._scrollAction = !0, this._scrollState ? this._scrollbar.runAction(cc.sequence(cc.moveTo(.2, cc.v2(this._scrollbarPos.x, this._scrollbarPos.y)), cc.callFunc(function () {
                            t._scrollAction = !1, t._scrollState = !1, i.scaleX = -1
                        }))) : this._scrollbar.runAction(cc.sequence(cc.moveTo(.2, cc.v2(this._scrollbarPos.x - 180 * o - 10, this._scrollbarPos.y)), cc.callFunc(function () {
                            t._scrollAction = !1, t._scrollState = !0, i.scaleX = 1
                    ...
                    var t = e.target.getComponent(F.default);
                    if (t) {
                        var o = h.default.urlParse(),
                            n = t.getTransactionId();
                        c.default._playview._netConnector.socketConnector && c.default._playview._netConnector.socketConnector.request(p.default.pomeloRoute.gameRecallUrl, u.default.makeWsPacket({
                            tid: n
                        }), function (e) {
                            !e || e.err ? cc.log("gameRecallURL error ", e) : K.default.getInstance().disPatchEvent(K.default.EVENT_OPEN, e.msg.url + "&loc=" + o.loc)
                        })
                    }
                    ...
                    if (this._businessStorage && !this._businessStorage.lockTarget) {
                        ...
                        if (o && o.state == H.default.STATE_REDAY) {
                            var n = o.aircraft;
                            if (n) { n.getComponent(U.default).setMovePosition(this.node.convertToWorldSpaceAR(cc.v2(n.x + e, n.y + t))) }
                        }
                    }
                    ...
                    return e.getComponent(I.default).init(function (e) {
                    ...
                    if (this._businessStorage.startGame) {
                        ...
                        if (this._airCraiftManager.setStartSyncPos(!0), this.closeNoviceTeaching(), !this._businessStorage.lockTarget) {
                    ...
                    var e = this;
                    if (!A.default.isShow() && !(this._$._bossNofity.active || this._tideStopFire && this._businessStorage.lockTarget)) {
                        this.closeNoviceTeaching();
                        for (var t = null, n = this._businessStorage.areaPlayers, i = 0; i < n.length; i++) {
                            if (this._userInfo.playerId == n[i].playerId) {
                                t = n[i];
                                break
                            }
                        } if (t && this._netConnector.socketConnector) {
                            this._netConnector.socketConnector.request(p.default.pomeloRoute.onFire, u.default.makeWsPacket({
                                ...
                                if (!t || t.err) { cc.log("onFire error ", t), o.disPatchEvent(o.AUTOFIRE_STOP, null); }
                                else if (t.code == 200) {
                                    if (e._ping.updateDelayTime(), t.data) {
                                        var n = O.default.getRealMoney(O.default.convertCentsToCredits(t.data.balance));
                                        e._userInfo.gold = n.rmp;
                                        var i = e._airCraiftManager.getAirCraft(e._userInfo.playerId);
                                        if (i) {
                                            var r = i.getComponent(U.default);
                                            r.isForceCloseFreeSpin(t.data), r.isFreeSpin() ? b.default.getInstance().playFreeSpinFire() : b.default.getInstance().playGunFire(t.data.cannonskin)
                                        }
                                    }
                                } else {
                                    if (t.code != 200 && t.code != 217 && t.code != 216) { return void A.default.showMsg(t.code); }
                                    t.code == 216 && (e._$._locktouchScreen.off(cc.Node.EventType.TOUCH_END, e), e._$._locktouchScreen.active = !1, o.disPatchEvent(o.AUTOFIRE_STOP, null), e._businessStorage.lockTarget = !1, e._businessStorage.lockTargetId = null, e._businessStorage.lockFishType = "", e._closeLockTarget(), A.default.showMsg(t.code.toString())), t.code == 217 ? e._shootDelay = -.9 : o.disPatchEvent(o.AUTOFIRE_STOP, null)
                                }
                            })
                        }
                    }
                    ...
                    if (this._ndBulletPool && this._businessStorage && !(this._businessStorage.bulletQueueLen() <= 0)) {
                        ...
                        for (var n, i, r, a, s, c = function () {
                            var e = o.chairId,
                                c = o.playerId == l._userInfo.playerId;
                            if (e < 0) {
                                return {
                                    value: void 0
                                };
                            }
                            if (l._$._bossNofity.active) {
                                return {
                                    value: void 0
                                };
                            }
                            if (!(n = l._airCraiftManager.getAirCraft(o.playerId))) {
                                return {
                                    value: void 0
                                };
                            }
                            i = n.getComponent(U.default).isFreeSpin() ? "bullet_free" : "bullet_" + (e + 1), r = 120, -3, a = z.default.getConfig("bullet")[i].small, n.getComponent(U.default).isFreeSpin() ? (r = 180, a = z.default.getConfig("bullet")[i].small) : o.cannonskin == 2 ? (r = 80, a = z.default.getConfig("bullet")[i].mid) : o.cannonskin == 3 && (r = 70, a = z.default.getConfig("bullet")[i].big);
                            var u = l._getBulletIns(),
                                p = u.getComponent(g.default);
                            if (!p) {
                                return cc.log("spawnBullet component not find"), {
                                    value: void 0
                                };
                            }
                            var h = l._$._ndTouchScreen.convertToWorldSpaceAR(n.position);
                            (h = l._ndBulletPool.convertToNodeSpaceAR(h)).y += 120, p.setFrameRate(l._frameRateTime), p.init(o.bulletId, h, 90, g.default.BULLET_DEFAULT_SPEED, a, o.lockTargetId, o.cannonskin, c, function (e) {
                                t._removeBulletNodeCacheMap(p.getId()), z.default.recyclePrefab(e, "bullet")
                            }, function (e) {
                                t._businessStorage && t._businessStorage.pushCollider({
                                    bid: e.bullet.tag,
                                    fid: e.fish.tag
                                })
                            }), p.isFreeSpin = n.getComponent(U.default).isFreeSpin(), s = l._getGunFireAnimIns(), n.addChild(s, -1, "gunfire");
                            var f = s.getComponent(v.default);
                            f.init(a, cc.v2(-3, r), function (e) {
                                z.default.recyclePrefab(e, "animGunFire")
                            }), f.playAnimation(), b.default.getInstance().playCastEffect(), l._insertBulletNodeCacheMap(o.bulletId, p), u.setParent(l._ndBulletPool), o = l._businessStorage.popBullet()
                        }, l = this; o;) {
                            var u = c();
                    ...
                    if (this._businessStorage && this._businessStorage.startGame) {
                        ...
                        if (t.length != 0 && !this._$._bossNofity.active) {
                            var o = t[0].bossId,
                                n = cc.instantiate(z.default.getPrefab("Boss"));
                            o < "Fish_05" ? this._ndEnemyPool.addChild(n, -1, "boss") : this._ndEnemyPool.addChild(n, 999, "boss");
                            var i = n.getComponent("Boss");
                            if (i) {
                                i.init(o, t[0], function (e) {
                                    z.default.recyclePrefab(e, "Boss")
                                }), b.default.getInstance().playBossBg(i.getFishType());
                                for (var r = i.getIds(), a = 0; a < r.length; a++) { this._insertFishNodeCacheMap(r[a], i); }
                                i.runShowTime(), this._businessStorage.sceneId == parseInt(o) && (this._businessStorage.sceneId++, this._businessStorage.sceneId + 1 >= j.default.MAX_SCENE && (this._businessStorage.sceneId = 0))
                            } else { cc.log("spawnBoss component not find") }
                        }
                    }
                    ...
                    if (this._businessStorage && this._businessStorage.startGame && !this._$._bossNofity.active && this._businessStorage.isPushBossSoldier(e)) {
                        ...
                        for (var a in r.data) {
                            for (var s = r.data[a].soldiers, c = 0; c < s.length; c++) {
                                var l = s[c],
                                    u = z.default.getConfig("boss")[i].soldier[l.soldierId],
                                    p = this._getEnemyIns(),
                    ...
                    if (this._ndEnemyPool) {
                        ...
                        if (this._businessStorage && !(o.length <= 0)) {
                            var n = !1;
                            if (o[0].type != "Fish_00" || o[0].state != p.default.consts.BOMB) {
                                for (var i = 0; i < o.length; i++) {
                                    var r = o[i];
                                    if (r.type >= "Fish_03" && r.type <= "Fish_08") { return void cc.log("miss enemy :", r.type); }
                                    if (r.state == p.default.consts.SOLO || r.state == p.default.consts.FREEZE || r.state == p.default.consts.SPEEDUP || r.state == p.default.consts.FREESPIN) {
                                        var a = this._getEnemyIns(),
                                            s = a.getComponent("Enemy");
                                        if (!s) { return void cc.log("spawnEnemy component not find"); }
                                        s.init(r, cc.v2(0, 0), !1, null, !1, function (e) {
                                            var o = e.getComponent(W.default);
                                            t._removeFishNodeCacheMap(o.getId()), z.default.recyclePrefab(e, "Enemy")
                                        }), s.setFishContainer(this._ndEnemyPool), a.setParent(this._ndEnemyPool), this._insertFishNodeCacheMap(r.id, s), r.state == p.default.consts.FREEZE ? n || (n = !0) : r.state == p.default.consts.SPEEDUP ? n || (b.default.getInstance().playTurboEnter(), n = !0) : r.state == p.default.consts.FREESPIN && (n || (b.default.getInstance().playFreeSpinEnter(), n = !0))
                                        ...
                                        var g = this._getEnemyIns(),
                                            y = g.getComponent("Enemy");
                                        if (!y) { return; }
                                        y.init(r, f[r.index], !1, null, !1, function (e) {
                                            var o = e.getComponent(W.default);
                                            t._removeFishNodeCacheMap(o.getId()), z.default.recyclePrefab(e, "Enemy")
                                        }), y.setFishContainer(this._ndEnemyPool), g.setParent(this._ndEnemyPool), this._insertFishNodeCacheMap(r.id, y)
                                    }
                                }
                            } else {
                                var m = z.default.getConfig("flock").flock_bomb.bomb_15.points;
                                if (!(P = (S = this._getEnemyIns()).getComponent(W.default))) { return; }
                                P.init(o[0], m[0], !1, null, !1, function (e) {
                                    var o = e.getComponent(W.default);
                                    t._removeFishNodeCacheMap(o.getId()), z.default.recyclePrefab(e, "Enemy")
                                }), P.setFishContainer(this._ndEnemyPool), S.setParent(this._ndEnemyPool), this._insertFishNodeCacheMap(o[0].id, P), n || (b.default.getInstance().playLightningEnter(), n = !0);
                                var v = o.slice(1, o.length);
                                v = v.sort(function () {
                                    return Math.random() - .5
                                });
                                for (var C = 1; C <= v.length; C++) {
                                    var S, P, A = o[C];
                                    if (!(P = (S = this._getEnemyIns()).getComponent(W.default))) { return; }
                                    A.alive = o[0].alive, P.init(A, m[C], !1, null, !1, function (e) {
                                        var o = e.getComponent(W.default);
                                        t._removeFishNodeCacheMap(o.getId()), z.default.recyclePrefab(e, "Enemy")
                                    }), P.setFishContainer(this._ndEnemyPool), S.setParent(this._ndEnemyPool), this._insertFishNodeCacheMap(A.id, P), n || (b.default.getInstance().playLightningEnter(), n = !0)
                                }
                            }
                        }
                    }
                    ...
                    if (this._businessStorage && !(this._businessStorage.colliderQueueLen() <= 0)) {
                        ...
                        if (b.default.getInstance().playHit(o), this._netConnector && this._netConnector.socketConnector) {
                            for (var a = null, s = this._businessStorage.areaPlayers, c = 0; c < s.length; c++) {
                                ...
                                var l = [];
                                for (c = 0; c < t.length; c++) { g.default.isUniqueBulletId(t[c]) && (t[c].creditBet = this._userInfo.rmpcannonCost[a.cannonLevel], t[c].denom = O.default.walletInfo.currentDenomination, t[c].currency = h.default.getUrlParam("cr"), l.push(t[c])); }
                                this._netConnector.socketConnector.request(p.default.pomeloRoute.onCollider, u.default.makeWsPacket(l), null)
                            }
                        }
                    }
                                ...
                                for (var r = 0; r < n[i].diefids.length; r++) {
                                    ...
                                    if (a instanceof W.default) {
                                        if ((l = a) && l.node && l.node.getParent()) {
                                            if (n[i].winscore[r] && this._playScreenGoldAnim(l.node.getParent().convertToWorldSpaceAR(l.node.position), n[i].fishscore[r], n[i].ftypes, n[i].playerId, n[i].score, n[i].cannonlevel), l.doDie(), l.getFishType() >= "Fish_09" && l.getFishType() <= "Fish_14") { this._playHitEffect(l, n[i].playerId, 8, !0), b.default.getInstance().playBingo(), this.runShake(30); }
                                            else {
                                                var s = z.default.getConfig("fish")[l.getFishType()];
                                                if (s.effect) {
                                                    var c = this._airCraiftManager.getAirCraft(n[i].playerId);
                                                    c && c.getComponent(U.default).playEffectAnimation(s)
                                                }
                                                if (n[i].pause && n[i].pause.length > 0) { continue; }
                                                if (n[i].typeBombs && n[i].typeBombs.length > 0) { continue; }
                                                this._playHitEffect(l, n[i].playerId, l.hasLuckyAura() ? 4 : 2, !!l.hasLuckyAura()), l.getFishType() <= "Fish_14" && l.getFishType() >= "Fish_00" ? this.runShake(30) : this.runShake(4)
                                            }
                                        }
                                    } else if (a instanceof G.default) {
                                        var l;
                                        if ((l = a) && l.node && l.node.getParent()) {
                                            n[i].winscore[r] && (this._playScreenGoldAnim(l.node.getParent().convertToWorldSpaceAR(l.node.position), n[i].fishscore[r], n[i].ftypes, n[i].playerId, n[i].score, n[i].cannonlevel), l.playHitAnimation());
                                            var u = l.removeOneIds();
                                            this._removeFishNodeCacheMap(u), l.getIds().length <= 0 ? (l.runToDie(), this._businessStorage.lockTargetId = null) : this._businessStorage.lockTargetId == u && (this._businessStorage.lockTargetId = l.getId()), this._playHitEffect(l, n[i].playerId, 16, !0), this.runShake(60)
                                        }
                    ...
                    this._animationPause && this._animationPause.playAnimation(e, function () {
                        j.default.disPatchEvent(j.default.PAUSE, !1)
                    })
                    ...
                    for (var t = !1, o = 0; o < e.length; o++) {
                        ...
                        if (n.length == 2) {
                            (n = n[0])[1];
                            if (n <= "Fish_07" ? b.default.getInstance().playCoinEffect(2) : n >= "Fish_08" && n <= "Fish_16" ? b.default.getInstance().playCoinEffect(1) : b.default.getInstance().playCoinEffect(0), n < "Fish_14") {
                                t = !0;
                                break
                            }
                        }
                    ...
                    if (a) {
                        var s = O.default.getRealAmountByOtherCannonLevel(t, this._userInfo.rmpcannonCost, r),
                            c = this._getAnimCoinType(s, o);
                        if (s > 0) {
                        ...
                        if (this._isShowGoldPlate(o) && this._bingoAnim) {
                            var f = a.aircraft.getComponent(U.default),
                                d = O.default.getRealAmountByOtherCannonLevel(i, this._userInfo.rmpcannonCost, r);
                            this._bingoAnim.setParent(this._$._ndTouchScreen), this._bingoAnim.zIndex = 99, this._bingoAnim.getComponent(L.default).play(a.aircraft.getParent().convertToWorldSpaceAR(a.aircraft.position), d, f.isMasterPlayer())
                        }
                    ...
                    this._businessStorage && this._businessStorage.lockTarget || (this.closeNoviceTeaching(), o.disPatchEvent(this._businessStorage.autoFire == 1 ? o.AUTOFIRE_STOP : o.AUTOFIRE_START, null))
                }, t.prototype._setAutoFireStatus = function (e) {
                    var t = this._$._btnAutoFire.getComponent(cc.Toggle);
                    t.isChecked ? t.uncheck() : t.check(), this._$._btnAutoFire.getChildByName("label_auto").getComponent(cc.Label).string = t.isChecked ? w.t("text.autofire.stop") : w.t("text.autofire"), e || (b.default.getInstance().playBtnEffect(), b.default.getInstance().playBtnAuto(!t.isChecked))
                }, t.prototype._closeAutoFire = function (e) {
                    var t = this._$._btnAutoFire.getComponent(cc.Toggle);
                    t.uncheck(), this._$._btnAutoFire.getChildByName("label_auto").getComponent(cc.Label).string = t.isChecked ? w.t("text.autofire.stop") : w.t("text.autofire"), e || (b.default.getInstance().playBtnEffect(), b.default.getInstance().playBtnAuto(!0))
                    ...
                    this._setLockTargeStatue(), this.closeNoviceTeaching(), this.scheduleOnce(function () {
                        e._$._btnLockTarget.getComponent(cc.Toggle).isChecked ? (e._businessStorage.lockTarget = !0, e._$._lockboard.active = !0) : (e._businessStorage.lockTarget = !1, e._businessStorage.lockTargetId = null, e._businessStorage.lockFishType = "", e._$._locktouchScreen.off(cc.Node.EventType.TOUCH_END, e), e._$._locktouchScreen.active = !1, e._$._lockboard.active = !1, e.unschedule(e.searchLockTargetAndFire), o.disPatchEvent(o.AUTOFIRE_STOP, null))
                    })
                }, t.prototype._setLockTargeStatue = function () {
                    var e = this._$._btnLockTarget.getComponent(cc.Toggle);
                    e.isChecked ? e.uncheck() : e.check(), this._$._btnLockTarget.getChildByName("label_lock").getComponent(cc.Label).string = e.isChecked ? w.t("text.unlocktarget") : w.t("text.locktarget"), b.default.getInstance().playBtnEffect(), b.default.getInstance().playBtnLock(!e.isChecked)
                }, t.prototype._closeLockTarget = function () {
                    var e = this._$._btnLockTarget.getComponent(cc.Toggle);
                    e.uncheck(), this._$._btnLockTarget.getChildByName("label_lock").getComponent(cc.Label).string = w.t("text.locktarget"), this.unschedule(this.searchLockTargetAndFire), b.default.getInstance().playBtnEffect(), b.default.getInstance().playBtnLock(!e.isChecked)
                    ...
                    this._tableSearchStorage && !this._tableSearchStorage.quitGameReq && (this._tableSearchStorage.quitGameReq = !0, this._btnQuitClick = !0, this._isCancelLock = !0, this._businessStorage.lockTarget = !1, this._businessStorage.lockTargetId = null, this._businessStorage.lockFishType = "", this._$._locktouchScreen.off(cc.Node.EventType.TOUCH_END, this), this._$._locktouchScreen.active = !1, this._$._lockboard.active = !1, this._closeLockTarget(), cc.log("_onBtnQuitTouchEnd _onBtnQuitTouchEnd"), o.disPatchEvent(o.AUTOFIRE_STOP, null))
                    ...
                    this._frameRateTime = e, this.showHide(), this.displayPlayers(), this.spawnBoss(e), this.spawnEnemy(e), this.onColliderHandle(e), this.onColliderResultHandle(e), this.autoLockTarget(e), this.fireHandle(e, !1), this.spawnBullet(e), this.moveSlaverAircraft(e), this.playTideAnimation(), this.checkEndGame(), this.closeBossNotify()
                }, t.prototype.autoLockTarget = function (e) {
                    if (this._businessStorage && this._businessStorage.startGame) {
                        if (this._businessStorage.lockTarget) {
                            if (!this._$._locktouchScreen.active) {
                                this._$._locktouchScreen.active = !0;
                                var t = this,
                                    n = this._$._locktouchScreen;
                                this._$._locktouchScreen.on(cc.Node.EventType.TOUCH_END, function (e) {
                                    var i = n.getParent().convertToNodeSpaceAR(e.getLocation());
                                    if (this._$._ndGunsight) {
                                        Math.round(p.default.consts.FRAME_HEIGHT / cc.winSize.height);
                                        if (this._$._ndGunsight.active = !0, this._$._ndGunsight.position = i, !t._businessStorage.lockFishType) {
                                            var r = this._$._ndGunsight.getComponent(x.default);
                                            r && r.clearFishSprite()
                                        }
                                    }
                                    var a = null,
                                        s = 0,
                                        c = this._$._ndGunsight.getParent().convertToWorldSpaceAR(this._$._ndGunsight.position);
                                    for (var l in t._fishesNodeCacheMap) {
                                        var u = t._fishesNodeCacheMap[l];
                                        u.isOnStage() && (u.node.getParent() && u.inRect(c) && (u.isEffectBox() ? a = l : u.score > s && (a = l, s = u.score)))
                                    }
                                    if (a || (cc.log("not find fishkey"), this._closeAutoFire(!0), this._businessStorage.autoFire = !1), a) {
                                        var h = t._fishesNodeCacheMap[a];
                                        t._businessStorage.lockTargetId = h.getId().toString(), t._businessStorage.lockFishType = h.getFishType();
                                        var f = this._$._ndGunsight.getComponent(x.default);
                                        f.setLockFish(t._businessStorage.lockFishType), f.showBox(), this._$._lockboard.active = !1, !this._$._selectRoomLevel.active && this._$._ndGunsight.active && this._businessStorage.lockTarget && o.disPatchEvent(o.AUTOFIRE_START, null);
                                        ...
                                        _ && (d = cc.v2(d.x, d.y - 240), _.setMovePosition(d), _.setLockMode(!0)), t.unschedule(t.searchLockTargetAndFire), t.schedule(t.searchLockTargetAndFire, .5, cc.macro.REPEAT_FOREVER, .5)
                                    }
                                }, this, !1)
                            }
                        } else if (this._$._ndGunsight && this._$._ndGunsight.active) {
                            this._$._ndGunsight.active = !1;
                            var i = this._airCraiftManager.getAirCraft(this._userInfo.playerId).getComponent(U.default);
                            i && i.setLockMode(!1)
                        }
                    }
                }, t.prototype.searchLockTargetAndFire = function () {
                    var e, t = this;
                    e = this._businessStorage.lockTargetId;
                    var n = this._getFishNodeCacheMap(e);
                    if (this._businessStorage.battleBoss || !n || n.isOnStage() || (cc.log("fish not on stage ", n.getId(), n.getFishType(), n.isOnStage()), n = null), this._tideStopFire) { return n = null, void (this._businessStorage.lockTargetId = null); }
                    var i = this._airCraiftManager.getAirCraft(this._userInfo.playerId).getComponent(U.default);
                    if (!n && this._businessStorage.lockTarget && (!n && this._businessStorage.lockTarget || i.abortLock(n))) {
                        if (n = this._findTargetFish(), this._businessStorage.lockTargetId = n ? n.getId() : null, !this._businessStorage.lockTargetId) { return void o.disPatchEvent(o.AUTOFIRE_STOP, null); }
                        this._$._ndGunsight.getComponent(x.default).lockFramePosBackToDefault()
                    }
                    if (n && n.node.getParent()) {
                        n && this._businessStorage.lockTargetId && !this._businessStorage.autoFire && this.scheduleOnce(function () {
                            !t._$._selectRoomLevel.active && t._$._ndGunsight.active && t._businessStorage.lockTarget && t._businessStorage.lockTargetId && o.disPatchEvent(o.AUTOFIRE_START, null)
                        }, 1);
                        var r = n.node.getParent().convertToWorldSpaceAR(n.node.position);
                        if (this._$._ndGunsight) {
                            var a = cc.v2(r.x, r.y + 30);
                            this._$._ndGunsight.active = !0, this._$._ndGunsight.position = this.node.convertToNodeSpaceAR(a), this._$._ndGunsight.getComponent(x.default).reLockFramePos(n.node)
                        }
                        i && (r = cc.v2(r.x, r.y - 240), i.setMovePosition(r))
                    } else { o.disPatchEvent(o.AUTOFIRE_STOP, null) }
                }, t.prototype.startGame = function () {
                    if (this._businessStorage) {
                        this.unscheduleAllCallbacks(), b.default.getInstance().playCashIn(), this.scheduleOnce(function () {
                            b.default.getInstance().bgStart()
                        }, 2), this._initPauseAnimNode(), this._isHideDrop = !1, this._hideDrawCount = 0, d.default.seed = this._businessStorage.area.seed;
                        var e = this;
                        ...
                        if (h.default.isShowFullScreenNotice(p.default.consts.ANDROID_FULLSCREEN_PLAY)) {
                            var o = (a = cc.instantiate(z.default.getPrefab("AndroidAskfullscreen"))).getComponent(k.default);
                        ...
                        if ((o = this._$._novice.getComponent(D.default)) && o.play(), this._businessStorage && this._businessStorage.area && this._businessStorage.area.stage == p.default.consts.AREA_STAGE_GROUP) {
                            var c = this._$._bossNofity.getComponent(M.default);
                            c && c.start()
                        }
                        var l = this._$._ndFishpondBg.getComponent(j.default);
                        if (l) {
                            var u = this.node.getChildByName("_ndFishpondBg").getChildByName("_bg1"),
                                f = this.node.getChildByName("_ndFishpondBg").getChildByName("_bg2");
                            u.y = 0, f.y = 1920, l.init(j.default.DIRECTION_Y, p.default.consts.BG_SCOLL_SPEED, this._businessStorage.sceneId, this._businessStorage.bgReverse, !1)
                        }
                    }
                    ...
                    var o = O.default.getRealMoney(t),
                        n = this._balance.getChildByName("currency"),
                        i = this._balance.getChildByName("balance");
                    if (this._cannonCost.getComponent(cc.Label).string = O.default.numberFormat(o.rmp), i.getComponent(cc.Label).string = O.default.numberFormat(this._userInfo.gold), o.isbehind || this._crfontend.getComponent(cc.Label).string == o.cy) {
                        if (o.isbehind && this._crbehind.getComponent(cc.Label).string != o.cy) {
                            this._crbehind.getComponent(cc.Label).string = o.cy, this._crfontend.active = !1;
                            r = h.default.getRealCurrency(this._walletStorage.currencySymbol);
                            n.getComponent(cc.Sprite).spriteFrame = z.default.getSpriteFrame("currencysymbol", "reelwinmeter_" + h.default.getRealSpriteCurrency(r)), h.default.getRealSpriteCurrency(r) == "\xa5" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "$" ? (n.setScale(.6), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "\u20bd" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -13))) : h.default.getRealSpriteCurrency(r) == "\u20ac" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "\u20ba" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -14))) : (n.setPosition(cc.v2(-52, -17)), n.setScale(1))
                        }
                    } else {
                        this._crfontend.getComponent(cc.Label).string = o.cy, this._crbehind.active = !1, this._crfontend.getComponent(cc.Label).string = o.isbehind ? "" : o.cy, this._crbehind.getComponent(cc.Label).string = o.isbehind ? o.cy : "";
                        var r = h.default.getRealCurrency(this._walletStorage.currencySymbol);
                        n.getComponent(cc.Sprite).spriteFrame = z.default.getSpriteFrame("currencysymbol", "reelwinmeter_" + h.default.getRealSpriteCurrency(r)), h.default.getRealSpriteCurrency(r) == "\xa5" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "$" ? (n.setScale(.6), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "\u20bd" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -13))) : h.default.getRealSpriteCurrency(r) == "\u20ac" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -15))) : h.default.getRealSpriteCurrency(r) == "\u20ba" ? (n.setScale(.75), n.setPosition(cc.v2(-52, -14))) : (n.setPosition(cc.v2(-52, -17)), n.setScale(1))
                    }
                }, t.prototype.closeBossNotify = function () {
                    if (this._$._bossNofity.active && this._businessStorage.startGame) {
                        if (this._businessStorage.area.stage == p.default.consts.AREA_STAGE_NORMAL || this._businessStorage.area.stage == p.default.consts.AREA_STAGE_WAIT) {
                    ...
                    for (var t = this.node.children, o = 0; o < t.length; o++) { t[o].active = e; }
                    e && (this._showcounter ? this._$._ndCounter && (this._$._ndCounter.active = !0) : this._$._ndCounter && (this._$._ndCounter.active = !1), this._onBtnJoyStickSwitchTouchEnd()), this._$._locktouchScreen.active = !1, this._$._selectRoomLevel.active = !1, this._$._bossNofity.active = !1, this._$._pathDraw.active = !1, h.default.isFreePlay() || (this._$._FreePlay.active = !1), this._isShow = e
                }, t.prototype.playTideAnimation = function () {
                    var e = this;
                    if (this._businessStorage && this._businessStorage.changeScene) {
                        this._businessStorage.changeScene = !1;
                        var t = cc.repeat(cc.sequence(cc.callFunc(function () {
                            b.default.getInstance().playWaveEffect()
                        }), cc.delayTime(1)), 20);
                        this.node.runAction(t);
                        for (var o = 0; o < this._ndEnemyPool.children.length; o++) {
                            var n = this._ndEnemyPool.children[o].getComponent("Enemy");
                            n && n.doDieForBossBattleWarning()
                        }
                        var i = this;
                        if (i._tideStopFire = !0, setTimeout(function () {
                            i._tideStopFire = !1
                        }, 9e3), this._bossWarning) { this._bossWarning.getComponent("BossWarning").playAnimation(); }
                        this.scheduleOnce(function (o) {
                            e.node.stopAction(t), e.scheduleOnce(function () {
                                b.default.getInstance().bgStart(), i._$._ndFishpondBg.getComponent(j.default) && (cc.log("now scene ", i._businessStorage.sceneId), j.default.disPatchEvent(j.default.CHANGE_SCEME, null), j.default.disPatchEvent(j.default.PAUSE, !1))
                            }, 55)
                        }, 6.5)
                    }
                    ...
                    if (this._$._novice.active) {
                        var e = this._$._novice.getComponent(D.default);
                        e && e.close()
                    }
                ...
                }, t.AUTOFIRE_START = "autofire_start", t.AUTOFIRE_STOP = "autofire_stop", t.HIDE_WAIT_TIME = 3e5, t.HIDE_WAIT_INITBG = 5, t._instance = null, t = o = i([a], t)
            }(s.default);
        ...
        "../Components/UI/AnimationEnemyDieBoom": "AnimationEnemyDieBoom",
        ...
        var r = cc._decorator,
            ...
            h = function (e) {
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    (this._$._recommend && (this._$._recommend.active = !1), this._$._msg) && (this._$._msg.getComponent(cc.Label).string = p.t(this._promptDialogStorage.errortype));
        ...
        var r = e("../../Utils/CCHelper"),
            ...
            l = (s.property, function (e) {
                ...
                return n(t, e), t.prototype.init = function (e) {
                    var t = this;
                    this._data = e;
                    var o = this.node.getChildByName("_freespin"),
                        n = this.node.getChildByName("_col1"),
                        i = this.node.getChildByName("_col2"),
                        r = this.node.getChildByName("_col3"),
                        a = this.node.getChildByName("_col4"),
                        s = this.node.getChildByName("_col5");
                    e ? (n.active = !0, i.active = !0, r.active = !0, a.active = !0, s.active = !0, this._data.fsw && this._data.fsw != 0 ? o.active = !0 : o.active = !1, this.initDate(), this.initTransactionId(), this.initBullets(), this.initBet(), this.initWinScore(), this.node.on(cc.Node.EventType.TOUCH_START, function (e) {
                        ...
                        var o = t.node.getChildByName("_event_bg");
                        o && (o.active = !1)
                    })) : (n.active = !1, i.active = !1, r.active = !1, a.active = !1, s.active = !1, o.active = !1)
                    ...
                    cc.log(this._data);
                    var r = a.default.getRealMoney(this._data.totalWager);
    ...
    StartSearchTableForPlayView: [function (e, t, o) {
        ...
        var r = cc._decorator,
            ...
            u = function (e) {
                ...
                return n(t, e), t.prototype.init = function (e, t, o) {
                    this.node.on(cc.Node.EventType.TOUCH_END, function (t) {
                        l.default.getInstance().playBtnEffect(), e(t)
        ...
        var r = cc._decorator,
            ...
            p = function (e) {
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    if (this._tableSearchStorage) {
                        var e = {};
                        e[this.searchParams[0].key] = parseInt(this.searchParams[0].value), this._tableSearchStorage.searchParams = e, this._tableSearchStorage.startSearch = !0, this.node.getParent().getParent().getChildByName("_selecttext").active = !1, this.node.getParent().active = !1, u.default.getInstance().playBtnEffect()
                    }
                }, t.prototype.onShowLight = function () {
                    this.node.runAction(cc.scaleTo(.1, 1.1))
                }, t.prototype.onCloseLight = function () {
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    this._initOnPushMsg || this._netConnector && this._netConnector.socketConnector && (this._initOnPushMsg = !0, this._netConnector.socketConnector.on(l.default.pomeloPushRoute.onKick, function (e) {
                        ...
                        if (cc.log("onGameStart ", t), e._businessStorage && (e._businessStorage.tableInfo = t.msg.table, e._businessStorage.playersInfo = t.msg.players, e._businessStorage.area = t.msg.area, e._businessStorage.areaPlayers = t.msg.areaPlayers, cc.log("game start area:", e._businessStorage.area), t.msg.playerId == e._userInfo.playerId)) {
                            e._businessStorage.startGame = !0, e._businessStorage.bgReverse = t.msg.area.reverse, e._businessStorage.sceneId = t.msg.area.scene;
                        ...
                        if (e._businessStorage) {
                            if (!e._businessStorage.startGame || u.default._playview._isHideDrop) { return; }
                            if (e._businessStorage.battleBoss && (e._businessStorage.battleBoss = !1), e._businessStorage.area.stage && (e._businessStorage.area.stage = l.default.consts.AREA_STAGE_NORMAL), e._businessStorage.sceneId != t.msg.scene && t.msg.scene && (e._businessStorage.sceneId = t.msg.scene), e._businessStorage.pushFishes(t.msg.fishes), u.default._playview && u.default._playview._hideStarttime != 0) {
                        ...
                        if (e._businessStorage) {
                            if (!e._businessStorage.startGame) { return; }
                            e._businessStorage.changeScene = !0, e._businessStorage.sceneId = t.msg.scene, e._businessStorage.bgReverse = t.msg.reverse
                        }
        ...
        var r = cc._decorator,
            ...
            f = function (e) {
                ...
                return n(t, e), t.prototype.onLoad = function () {
                    ...
                    e.loginType = "web", e.uid = e.u, e.m == 1 && (e.u = "G-" + Math.floor(1e8 * Math.random()) + 0), e.uid = e.u, e.loginType == "web" && (this.ssoRequestPacket = e)
                    ...
                    c.default.setRecommendData(e), h.default.startToLoadScene()
    ...
    WebViewGameRecall: [function (e, t, o) {
        "use strict";
        cc._RF.push(t, "f2532UVyhpHDq2IN9KqnOV9", "WebViewGameRecall");
        var n = this && this.__extends || function () {
            var e = function (t, o) {
                return (e = Object.setPrototypeOf || {
                    __proto__: []
        ...
        var r = cc._decorator,
            ...
            s = (r.property, function (e) {
                ...
                return n(t, e), o = t, t.prototype.onLoad = function () {
                    ...
                    this.useIOSWebView(!0), cc.log("recall url", e), o.instance.node.getChildByName("_webView").active = !0;
                    var t = o.instance.node.getChildByName("_closeBtn");
                    t.x = o.instance.node.getChildByName("_webView").getContentSize().width / 2 - 45, t.y = o.instance.node.getChildByName("_webView").getContentSize().height / 2 + 62, t.active = !0, o.instance.webview.url = e
    ...
    en: [function (e, t, o) {
        ...
        cc._RF.push(t, "c178dxcKLNJfKddMNzyhVeR", "en"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.en = {
            ...
            "fish.pt.inst.title": "AIRCOMBAT1942 RULES",
            "fish.pt.inst.bosses": "BOSS BATTLE - When entering BOSS BATTLE time , each BOSS on the field can be continuously killed until the end of the battle time, and the kill reward multiple is (88x ~ 388x).",
            "fish.pt.inst.speedup": "SPEED UP - Wins of this item type will increase fire speed and multiply wins by 10x, 15x, 20x, 25x, 30x, 35x, 40x, 45x, 50x.",
            "fish.pt.inst.lightning": "Nuclear bomb - Wins of this item type will cause a ranged attack to kill a certain number of enemies of the same type around.",
            "fish.pt.inst.freegame": "Free Shooting -  Wins of this item type will get free shooting for a certain period of time. This function will be automatically canceled when you leave the game or change rooms."
        }, cc._RF.pop()
    }, {}],
    ja: [function (e, t, o) {
        "use strict";
        cc._RF.push(t, "1c976GXABpDK7qXZ97L9Hrd", "ja"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.ja = {
            ...
            "fish.pt.inst.bosses": "\u9b54\u738b\u306e\u6226\u5834-\u9b54\u738b\u306e\u6226\u95d8\u671f\u9593\u306b\u5165\u308b\u3068\u3001\u30d5\u30a3\u30fc\u30eb\u30c9\u4e0a\u306e\u5404\u9b54\u738b\u306f\u3001\u6226\u95d8\u6642\u9593\u306e\u7d42\u308f\u308a\u307e\u3067\u7d99\u7d9a\u7684\u306b\u6bba\u3055\u308c\u308b\u3053\u3068\u304c\u3067\u304d\u3001\u30ad\u30eb\u5831\u916c\u306e\u500d\u6570\u306f\uff0888x \u301c 388x\uff09\u3067\u3059\u3002",
            ...
            "fish.pt.inst.freegame": "\u7121\u6599\u5c04\u6483-\u3053\u306e\u30a2\u30a4\u30c6\u30e0\u30bf\u30a4\u30d7\u306e\u52dd\u5229\u306f\u3001\u4e00\u5b9a\u671f\u9593\u7121\u6599\u5c04\u6483\u3092\u53d6\u5f97\u3057\u307e\u3059\u3002\u3053\u306e\u6a5f\u80fd\u306f\u3001\u30b2\u30fc\u30e0\u3092\u96e2\u308c\u305f\u308a\u90e8\u5c4b\u3092\u5909\u3048\u305f\u308a\u3059\u308b\u3068\u81ea\u52d5\u7684\u306b\u30ad\u30e3\u30f3\u30bb\u30eb\u3055\u308c\u307e\u3059\u3002"
        }, cc._RF.pop()
    }, {}],
    ko: [function (e, t, o) {
        "use strict";
        cc._RF.push(t, "a050dGUT2FNbKO88Tz6T0AJ", "ko"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.ko = {
            "text.loading": "LOADING",
            "text.search": "SEARCHING",
            "text.ok": "OK",
            "text.cancel": "CANCEL",
    ...
    ru: [function (e, t, o) {
        ...
        cc._RF.push(t, "c18d4qlJIRPa6HT54xeak3f", "ru"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.ru = {
            ...
            "fish.pt.inst.title": "\u041f\u0440\u0430\u0432\u0438\u043b\u0430 AIRCOMBAT1942",
            "fish.pt.inst.bosses": "BOSS BATTLE - \u043f\u0440\u0438 \u0432\u0432\u043e\u0434\u0435 \u0432\u0440\u0435\u043c\u0435\u043d\u0438 BOSS BATTLE \u043a\u0430\u0436\u0434\u044b\u0439 \u0431\u043e\u0441\u0441 \u043d\u0430 \u043f\u043e\u043b\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u043d\u0435\u043f\u0440\u0435\u0440\u044b\u0432\u043d\u043e \u0443\u0431\u0438\u0442 \u0434\u043e \u043a\u043e\u043d\u0446\u0430 \u0431\u0438\u0442\u0432\u044b, \u0430 \u043a\u0440\u0430\u0442\u043d\u043e\u0441\u0442\u044c \u043d\u0430\u0433\u0440\u0430\u0434\u044b \u0437\u0430 \u0443\u0431\u0438\u0439\u0441\u0442\u0432\u043e \u0440\u0430\u0432\u043d\u0430 (88x ~ 388x).",
            ...
            "fish.pt.inst.freegame": "\u0421\u0432\u043e\u0431\u043e\u0434\u043d\u0430\u044f \u0441\u0442\u0440\u0435\u043b\u044c\u0431\u0430 - \u041f\u043e\u0431\u0435\u0434\u044b \u044d\u0442\u043e\u0433\u043e \u0442\u0438\u043f\u0430 \u043f\u043e\u043b\u0443\u0447\u0430\u0442 \u0431\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u0443\u044e \u0441\u0442\u0440\u0435\u043b\u044c\u0431\u0443 \u0432 \u0442\u0435\u0447\u0435\u043d\u0438\u0435 \u043e\u043f\u0440\u0435\u0434\u0435\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u043f\u0435\u0440\u0438\u043e\u0434\u0430 \u0432\u0440\u0435\u043c\u0435\u043d\u0438. \u042d\u0442\u0430 \u0444\u0443\u043d\u043a\u0446\u0438\u044f \u0431\u0443\u0434\u0435\u0442 \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043e\u0442\u043c\u0435\u043d\u0435\u043d\u0430, \u043a\u043e\u0433\u0434\u0430 \u0432\u044b \u0432\u044b\u0445\u043e\u0434\u0438\u0442\u0435 \u0438\u0437 \u0438\u0433\u0440\u044b \u0438\u043b\u0438 \u043c\u0435\u043d\u044f\u0435\u0442\u0435 \u043a\u043e\u043c\u043d\u0430\u0442\u044b."
        }, cc._RF.pop()
    }, {}],
    th: [function (e, t, o) {
        "use strict";
        cc._RF.push(t, "7fefdH5hWBJDYy7rVoulvGY", "th"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.th = {
            ...
            "fish.pt.inst.bosses": "\u0e2a\u0e19\u0e32\u0e21\u0e23\u0e1a\u0e02\u0e2d\u0e07\u0e23\u0e32\u0e0a\u0e32\u0e1b\u0e35\u0e28\u0e32\u0e08 - \u0e40\u0e21\u0e37\u0e48\u0e2d\u0e40\u0e02\u0e49\u0e32\u0e2a\u0e39\u0e48\u0e23\u0e30\u0e22\u0e30\u0e40\u0e27\u0e25\u0e32\u0e01\u0e32\u0e23\u0e15\u0e48\u0e2d\u0e2a\u0e39\u0e49\u0e02\u0e2d\u0e07\u0e23\u0e32\u0e0a\u0e32\u0e1b\u0e35\u0e28\u0e32\u0e08\u0e41\u0e15\u0e48\u0e25\u0e30\u0e23\u0e32\u0e0a\u0e32\u0e1b\u0e35\u0e28\u0e32\u0e08\u0e1a\u0e19\u0e2a\u0e19\u0e32\u0e21\u0e2a\u0e32\u0e21\u0e32\u0e23\u0e16\u0e06\u0e48\u0e32\u0e44\u0e14\u0e49\u0e2d\u0e22\u0e48\u0e32\u0e07\u0e15\u0e48\u0e2d\u0e40\u0e19\u0e37\u0e48\u0e2d\u0e07\u0e08\u0e19\u0e01\u0e27\u0e48\u0e32\u0e08\u0e30\u0e2a\u0e34\u0e49\u0e19\u0e2a\u0e38\u0e14\u0e40\u0e27\u0e25\u0e32\u0e23\u0e1a\u0e41\u0e25\u0e30\u0e23\u0e32\u0e07\u0e27\u0e31\u0e25\u0e01\u0e32\u0e23\u0e06\u0e48\u0e32\u0e2b\u0e25\u0e32\u0e22\u0e04\u0e23\u0e31\u0e49\u0e07\u0e04\u0e37\u0e2d (88x ~ 388x)",
            ...
            "fish.pt.inst.freegame": "Free Shooting - \u0e0a\u0e19\u0e30\u0e1b\u0e23\u0e30\u0e40\u0e20\u0e17\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23\u0e19\u0e35\u0e49\u0e08\u0e30\u0e44\u0e14\u0e49\u0e23\u0e31\u0e1a\u0e01\u0e32\u0e23\u0e22\u0e34\u0e07\u0e1f\u0e23\u0e35\u0e43\u0e19\u0e0a\u0e48\u0e27\u0e07\u0e23\u0e30\u0e22\u0e30\u0e40\u0e27\u0e25\u0e32\u0e2b\u0e19\u0e36\u0e48\u0e07 \u0e1f\u0e31\u0e07\u0e01\u0e4c\u0e0a\u0e31\u0e48\u0e19\u0e19\u0e35\u0e49\u0e08\u0e30\u0e16\u0e39\u0e01\u0e22\u0e01\u0e40\u0e25\u0e34\u0e01\u0e42\u0e14\u0e22\u0e2d\u0e31\u0e15\u0e42\u0e19\u0e21\u0e31\u0e15\u0e34\u0e40\u0e21\u0e37\u0e48\u0e2d\u0e04\u0e38\u0e13\u0e2d\u0e2d\u0e01\u0e08\u0e32\u0e01\u0e40\u0e01\u0e21\u0e2b\u0e23\u0e37\u0e2d\u0e40\u0e1b\u0e25\u0e35\u0e48\u0e22\u0e19\u0e2b\u0e49\u0e2d\u0e07"
        }, cc._RF.pop()
    }, {}],
    ...
    "zh-hans": [function (e, t, o) {
        ...
        cc._RF.push(t, "f7c08RqK+lKKI8QCwkJwps3", "zh-hans"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages["zh-hans"] = {
            ...
            "fish.pt.inst.title": "\u654c\u4eba\u4ecb\u7d39",
            "fish.pt.inst.bosses": "\u9b54\u738b\u6218\u573a - \u5f53\u8fdb\u5165\u9b54\u738b\u6218\u6597\u65f6\u6bb5\uff0c\u6bcf\u53ea\u5728\u573a\u4e0a\u7684\u9b54\u738b\u53ef\u8fde\u7eed\u51fb\u6740\u81f3\u6218\u6597\u65f6\u95f4\u7ed3\u675f\uff0c\u51fb\u6740\u5956\u52b1\u500d\u6570\u4e3a(88x ~ 388x)",
            "fish.pt.inst.speedup": "\u52a0\u901f\u5c04\u51fb - \u6b64\u9053\u5177\u88ab\u51fb\u6740\u65f6\uff0c\u4f1a\u63d0\u9ad8\u5c04\u51fb\u901f\u5ea6\u5e76\u4e14\u5f97\u5230\u989d\u5916\u7684\u5956\u52b1\u500d\u6570(10x/15x/20x/25x/30x/35x/40x/45x/50x)",
            "fish.pt.inst.lightning": "\u6838\u5f39 - \u6b64\u9053\u5177\u88ab\u51fb\u6740\u65f6\uff0c\u5c06\u4f1a\u9020\u6210\u8303\u56f4\u6027\u653b\u51fb\u4e00\u5e76\u51fb\u6740\u56db\u5468\u67d0\u4e2a\u6570\u91cf\u540c\u7c7b\u578b\u7684\u654c\u4eba",
            "fish.pt.inst.freegame": "\u514d\u8d39\u5c04\u51fb - \u6b64\u9053\u5177\u88ab\u51fb\u6740\u65f6\uff0c\u5c06\u5f97\u5230\u4e00\u5b9a\u65f6\u95f4\u7684\u514d\u8d39\u5c04\u51fb\uff0c\u4e2d\u9014\u79bb\u5f00\u6e38\u620f\u6216\u662f\u6362\u623f\u95f4\u6b64\u529f\u80fd\u5c06\u81ea\u52a8\u53d6\u6d88"
        }, cc._RF.pop()
    }, {}],
