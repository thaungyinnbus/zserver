// 6dd8267e-2548-4047-b205-827c86de3db5
...
function NeutrinoEffect(ctx) {
	...
	function Emitter_glowSparks() {

		var _1, _3, _4 = [], _4i, _4s = [], _5 = [], _7, _8 = [], _10, _12, _14, _15, _16, _17 = [], _19 = [], _20=[], _20a=[], _20i=[], _21=[], _21fs=[], _21vs=[], _21rw=[], _21rwn=[], _21rwl, _21v=[], _21p=[], _21dtl, _21dtp, _21df, _21fsd=[], _22=[], _22x=[], _22y=[], _22z=[], _23, _23i0, _23s0 = [];
		this.pe = [{xe:1,Rc:1,Sc:1,renderStyleIndex:0}];
		this.name = "glowSparks";
		...
		this.fd = function(Bd, Xb) {
			...
			ctx.W(_5, _4[0], _4[1], 0);
			Xb._6 = [];
			ctx.c(Xb._6, Bd.Ab, _5);
			_7 = 100 + Bd.Ld.rand() * (1500 - 100);
			ctx.randv3gen(_8, _7, Bd.Ld.rand);
			Xb._9 = [];
			ctx.T(Xb._9, _8);
			_10 = 0.1 + Bd.Ld.rand() * (3 - 0.1);
			Xb._11 = _10;
			_12 = 15 + Bd.Ld.rand() * (50 - 15);
			Xb._13 = _12;
			_14 = 1 + Bd.Ld.rand() * (1 - 1);
			_15 = 0.7 + Bd.Ld.rand() * (1 - 0.7);
			_16 = 0.7 + Bd.Ld.rand() * (1 - 0.7);
			ctx.W(_17, _14, _15, _16);
			Xb._18 = [];
			ctx.T(Xb._18, _17);
			ctx.T(Xb.Ab, Xb._6);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			Xb._ += Qb;
			ctx.W(_19, 0, 100, 0);
			ctx.u(_20a, [100,50,30], Bd.Ld.Rb);
			ctx.c(_20a, _20a, Xb._6);
			ctx.u(_20i, _20a, 1.0 / 1000); 
			ctx.xb(_20, _20i);
			ctx.k(_20, _20, [0.0078125,0.0078125,0.0078125]);
			ctx.c(_20, _20, [-1,-1,-1]);
			ctx.u(_20, _20, 1500);
			ctx.T(_21fs, _19);
			ctx.c(_21fs, _21fs, _20);
			ctx.T(_21vs, [0,0,0]);
			ctx.u(_21v, _21fs, Qb);
			ctx.c(_21v, _21v, Xb._9);
			ctx.u(_21p, _21v, Qb);
			ctx.c(_21p, _21p, Xb._6);
			ctx.T(Xb._6, _21p);
			ctx.T(Xb._9, _21v);
			ctx.T(Xb.Ab, Xb._6);
			ctx.Q(_22z, [0,0,1]);
			ctx.I(_22x, Xb._9, _22z);
			ctx.Q(_22x, _22x);
			ctx.I(_22y, _22z, _22x);
			ctx.pb(_22, _22x, _22y, _22z);
			_23i0=(Xb._<0?0:(Xb._>1?1:Xb._));
			_23i0<0.1?ctx.V(_23s0,0,(_23i0-0)*10):ctx.V(_23s0,1,(_23i0-0.1)*1.11111);
