// d264fb16-7686-4a00-b065-05a038d6d6e1
...
function NeutrinoEffect(ctx) {
	...
	this.textures = Resources.readData("neutrinoEffects").coolDown.texturePaths;
	this.materials = [0];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]},{materialIndex:0,textureIndices:[1]}];
	this.Xe = 10100;

	function Emitter_childSmoke() {

		var _1 = [], _3 = [], _4 = [], _6, _8, _8i0, _8s0 = [], _10, _12 = [], _13=[], _13fs=[], _13vs=[], _13rw=[], _13rwn=[], _13rwl, _13v=[], _13p=[], _13dtl, _13dtp, _13df, _13fsd=[], _14, _16, _16i0, _16s0 = [], _17, _18, _18i0, _18s0 = [], _15;
		this.pe = [{xe:0,Rc:4,Sc:1,renderStyleIndex:0}];
		this.name = "childSmoke";
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			Xb._7 = _14;
			ctx.T(Xb.Ab, Xb._2);
			_16i0=(Xb._<0?0:(Xb._>1?1:Xb._));
			ctx.V(_16s0,0,(_16i0-0)*1);
			_16 = Db.nb(Bd._16[0][_16s0[0]],_16s0[1]);
			_17 = (Xb._9 * _16);
			_18i0=(Xb._<0?0:(Xb._>1?1:Xb._));
			_18i0<0.6?_18i0<0.1?ctx.V(_18s0,0,(_18i0-0)*10):ctx.V(_18s0,1,(_18i0-0.1)*2):ctx.V(_18s0,2,(_18i0-0.6)*2.5);
	...
	function Emitter_parent() {
		...
		var _1 = [], _5, _6, _7, _7i0, _7s0 = [], _8 = [[], []], _8i, _8s = [], _9 = [], _10op0=[], _11, _12;
		...
		this.ud = function(Bd) {
			...
			Bd._8 = [
				[[[122.5,-169],[0.707533,-0.70668]],[[130.172,-176.663],[0.708533,-0.705678]],[[137.855,-184.315],[0.709825,-0.704378]],[[145.552,-191.952],[0.711537,-0.702649]],[[153.267,-199.572],[0.713841,-0.700307]],[[161.007,-207.165],[0.716851,-0.697227]],[[168.779,-214.724],[0.720111,-0.693859]],[[176.587,-222.247],[0.721726,-0.692179]],[[184.413,-229.753],[0.720111,-0.693859]],[[192.221,-237.276],[0.716852,-0.697226]],[[199.993,-244.835],[0.71384,-0.700309]],[[207.733,-252.429],[0.711538,-0.702647]],[[215.448,-260.048],[0.709825,-0.704378]],[[223.145,-267.685],[0.708532,-0.705679]],[[230.828,-275.337],[0.707534,-0.70668]],[[238.5,-283],[0.707534,-0.70668]],[[238.5,-283],[0.707534,-0.70668]]]
			];
			Bd.uc(new Emitter_childSmoke(), { xc: 1, sd: false });
			Bd.jd = 100;
			Bd.Vc = 0;
		}
