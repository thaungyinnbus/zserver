// b54a2132-bcc3-49cb-bb1d-2b6b42cd3a05
...
function NeutrinoEffect(ctx) {
	...
	this.textures = Resources.readData("neutrinoEffects").countupSparks.texturePaths;
	this.materials = [1];
	...
	function Emitter_DefaultEmitter() {
		...
		var _1 = [], _3, _4, _5, _6 = [], _8, _9, _10, _10i0, _10s0 = [], _11 = [], _11i0, _11s0 = [], _11i1, _11s1 = [], _11i2, _11s2 = [], _12=[], _12a=[], _12i=[], _13=[], _13fs=[], _13vs=[], _13rw=[], _13rwn=[], _13rwl, _13v=[], _13p=[], _13dtl, _13dtp, _13df, _13fsd=[], _14=[], _14x=[], _14y=[], _14z=[], _15, _16, _16i0, _16s0 = [], _17, _18, _18i0, _18s0 = [];
		...
		this.fd = function(Bd, Xb) {
			...
			_3 = -400 + Bd.Ld.rand() * (400 - -400);
			_4 = 0 + Bd.Ld.rand() * (100 - 0);
			_5 = 0 + Bd.Ld.rand() * (0 - 0);
			ctx.W(_6, _3, _4, _5);
			Xb._7 = [];
			ctx.T(Xb._7, _6);
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_8 = 1;
			_9 = (Xb._ / _8);
			_10i0=(_9<0.0231309?0.0231309:(_9>1?1:_9));
			ctx.V(_10s0,0,(_10i0-0.0231309)*1.02368);
			_10 = Db.nb(Bd._10[0][_10s0[0]],_10s0[1]);
			_11i0=(_9<0?0:(_9>1?1:_9));
			ctx.V(_11s0,0,(_11i0-0)*1);
			_11i1=(_9<0?0:(_9>1?1:_9));
			_11i1<0.132277?ctx.V(_11s1,0,(_11i1-0)*7.55989):ctx.V(_11s1,1,(_11i1-0.132277)*1.15244);
			_11i2=(_9<0?0:(_9>1?1:_9));
			ctx.V(_11s2,0,(_11i2-0)*1);
			ctx.W(_11, Db.nb(Bd._11[0][_11s0[0]],_11s0[1]),Db.nb(Bd._11[1][_11s1[0]],_11s1[1]),Db.nb(Bd._11[2][_11s2[0]],_11s2[1]));
			ctx.u(_12a, [0,-400,0], Bd.Ld.Rb);
			ctx.c(_12a, _12a, Xb._2);
			ctx.u(_12i, _12a, 1.0 / 1000);
			ctx.xb(_12, _12i);
			ctx.k(_12, _12, [0.0078125,0.0078125,0.0078125]);
			ctx.c(_12, _12, [-1,-1,-1]);
			ctx.u(_12, _12, 0);
			ctx.T(_13fs, _11);
			ctx.c(_13fs, _13fs, _12);
			ctx.T(_13vs, [0,0,0]);
			_13dtl = Qb;
			ctx.T(_13v, Xb._7);
			ctx.T(_13p, Xb._2);
			...
			_8 = 1;
			_9 = (Xb._ / _8);
			_16i0=(_9<0?0:(_9>1?1:_9));
			ctx.V(_16s0,0,(_16i0-0)*1);
			_16 = Db.nb(Bd._16[0][_16s0[0]],_16s0[1]);
			_17 = (_15 * _16);
			_18i0=(_9<0?0:(_9>1?1:_9));
			_18i0<0.824152?_18i0<0.0450704?ctx.V(_18s0,0,(_18i0-0)*22.1875):ctx.V(_18s0,1,(_18i0-0.0450704)*1.28356):ctx.V(_18s0,2,(_18i0-0.824152)*5.68674);
	...
	function Emitter_DefaultEmitter1() {
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_8 = 2;
			_9 = (Xb._ / _8);
			_10i0=(_9<0.0231309?0.0231309:(_9>1.02341?1.02341:_9));
			ctx.V(_10s0,0,(_10i0-0.0231309)*0.999725);
			_10 = Db.nb(Bd._10[0][_10s0[0]],_10s0[1]);
			_11i0=(_9<0?0:(_9>1?1:_9));
			ctx.V(_11s0,0,(_11i0-0)*1);
			_11i1=(_9<0?0:(_9>1?1:_9));
