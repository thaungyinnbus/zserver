// 294eb4b8-1ffb-4f9d-b891-be04e2244f70
...
function NeutrinoEffect(ctx) {
	...
	this.textures = Resources.readData("neutrinoEffects").rsBlackSmoke.texturePaths;
	this.materials = [2];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]}];
	this.Xe = 100;

	function Emitter_smokingRuin() {

		var _1 = [], _2 = [], _4 = [], _5 = [], _8, _8i0, _8s0 = [], _10, _12 = [], _13=[], _13a=[], _13i=[], _14=[], _14fs=[], _14vs=[], _14rw=[], _14rwn=[], _14rwl, _14v=[], _14p=[], _14dtl, _14dtp, _14df, _14fsd=[], _15, _16, _17, _17i0, _17s0 = [];
		this.pe = [{xe:0,Rc:4,Sc:1,renderStyleIndex:0}];
		this.name = "smokingRuin";
		...
		this.fd = function(Bd, Xb) {
			Xb._ = 0.0;
			ctx.randv2gen(_1, 10, Bd.Ld.rand);
			ctx.W(_2, _1[0], _1[1], 0);
			Xb._3 = [];
			ctx.c(Xb._3, Bd.Ab, _2);
			ctx.randv2gen(_4, 100, Bd.Ld.rand);
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			ctx.c(_13a, _13a, Xb._3);
			ctx.u(_13i, _13a, 1.0 / 100); 
			ctx.xb(_13, _13i);
			...
			_17i0<0.1?ctx.V(_17s0,0,(_17i0-0)*10):ctx.V(_17s0,1,(_17i0-0.1)*1.11111);
