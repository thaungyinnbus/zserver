...
})(
    {
        ...
        FNgi: [
            function (require, module, exports) {
                ...
                function e(e, r, n, t, a, u, l) {
                    ...
                    o.done ? r(i) : Promise.resolve(i).then(t, a);
                }
                function r(r) {
                    return function () {
                        var n = this,
                ...
                var n = {};
                n.renderRules = (function () {
                    var e = r(
                        regeneratorRuntime.mark(function e(r, n, t, a, u) {
                            return regeneratorRuntime.wrap(function (e) {
                                for (;;)
                                    switch ((e.prev = e.next)) {
                                        case 0:
                                            return (
                                                "rules/rules.html?gameid=<gameid>&langid=<language>",
                                                "rules/templates/<gameid>.<nortp>.<language>.html",
                                                (t = t.replace("_sw", "")),
                                                (e.next = 5),
                                                fetch(r + "/" + n)
                                                    .then(function (e) {
        ...
        HDNH: [
            function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = exports.fetchTemplateName = void 0);
                const e = {};
                function t(e, t) {
                    return fetch(e)
                        .then(function (e) {
                ...
                (e.readTemplate = (e, t) => {
                    return fetch(`${t}/rules/templates/${e}.hbs`).then((e) =>
                        e.text()
                    );
                }),
                    (e.readLanguage = (e, n) => {
                        return t(
                            `${n}/langlib/${e}/${e}.json`,
                            `${n}/langlib/en/en.json`
                        );
                    }),
                    (e.readLanguageRules = (e, n) => {
                        return t(
                            `${n}/rules/${e}/rulestext.json`,
                            `${n}/rules/en/rulestext.json`
                        );
                    });
                const n = (e) => {
                        const t = {};
                    ...
                    r = async (e, t) => {
                        const n = e.replace("_sw", ""),
                            r = `${t}/rules/templates_config.json`,
                            s = await fetch(r)
                                .then((e) => e.json())
                                .then((e) => e[n])
                                .catch((e) => {});
                        return s ? s.template : n;
                    };
                exports.fetchTemplateName = r;
                var s = e;
                exports.default = s;
            },
            {},
        ...
        Xl3Y: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0);
                var e = t(require("./templateReader"));
                function t(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                const a = {
                    generate: async (t, a, r) => {
                        const u = e.default.readLanguage(t, r),
                            d = e.default.readLanguageRules(t, r);
                        return Promise.all([u, d]).then((e) => ({
                            ...e[0],
                            ...e[1],
                            ...a,
                        }));
            ...
            function (require, module, exports) {
                ...
                function r(t, o) {
                    ...
                    n &&
                        ...
                        (t += " - " + i + ":" + a));
                    for (
                        var l = Error.prototype.constructor.call(this, t),
                            s = 0;
                        s < e.length;
                        s++
                    )
                ...
                (exports.default = function (t) {
                    t.registerHelper("blockHelperMissing", function (r, a) {
                        ...
                        if (a.data && a.ids) {
                            ...
                            (n.contextPath = e.appendContextPath(
                                a.data.contextPath,
                                a.name
                            )),
                                (a = { data: n });
                ...
                (exports.default = function (t) {
                    t.registerHelper("with", function (t, a) {
                        ...
                        return (
                            a.data &&
                                a.ids &&
                                ((i = e.createFrame(a.data)).contextPath =
                                    e.appendContextPath(
                                        a.data.contextPath,
                                        a.ids[0]
                                    )),
        ...
        i17H: [
            ...
            {
                "./helpers/block-helper-missing": "Wf8o",
                "./helpers/each": "Xokv",
                "./helpers/helper-missing": "LNjc",
                "./helpers/if": "d6oL",
                "./helpers/log": "cInn",
                "./helpers/lookup": "Z1fq",
                "./helpers/with": "odPH",
        ...
        aTsJ: [
            function (require, module, exports) {
                ...
                (exports.__esModule = !0),
                    (exports.registerDefaultDecorators = o);
        ...
        LNs7: [
            function (require, module, exports) {
                ...
                function r() {
                    for (
                        var r = arguments.length, t = Array(r), o = 0;
                        o < r;
                        o++
                    )
                        t[o] = arguments[o];
                    return e.extend.apply(
                        void 0,
                        [Object.create(null)].concat(t)
                    );
                }
            },
            { "../utils": "cXff" },
        ...
        kDll: [
            function (require, module, exports) {
                ...
                function l(e) {
                    ...
                    return (
                        ...
                        {
                            properties: {
                                whitelist: t.createNewLookupObject(
                                    r,
            ...
            { "./create-new-lookup-object": "LNs7", "../logger": "xQQ0" },
        ],
        d7Tx: [
            function (require, module, exports) {
                "use strict";
        ...
        hf4N: [
            function (require, module, exports) {
                ...
                function c(e, r) {
                    ...
                    var a = {
                        ...
                        lookup: function (e, r) {
                            for (var t = e.length, o = 0; o < t; o++) {
                                if (null != (e[o] && a.lookupProperty(e[o], r)))
                                    return e[o][r];
                            }
                        },
                        lambda: function (e, r) {
                    ...
                    function i(r) {
                        ...
                        function s(r) {
                            return (
                                "" +
                                e.main(a, r, a.helpers, a.partials, o, l, n)
                            );
                        }
                        return (
                            e.useDepths &&
                ...
                function w(e, r, t, a, n, i) {
                    if (e.decorator) {
                        var l = {};
                        (r = e.decorator(r, l, t, a && a[0], n, i, a)),
                            o.extend(r, l);
                    }
                    return r;
                }
        ...
        LmTF: [
            ...
            {
                "./handlebars/base": "d7Tx",
                "./handlebars/safe-string": "m6q2",
                "./handlebars/exception": "Whac",
                "./handlebars/utils": "cXff",
                "./handlebars/runtime": "hf4N",
                "./handlebars/no-conflict": "Pvge",
            },
        ],
        WQqK: [
            function (require, module, exports) {
        ...
        RaFW: [
            function (require, module, exports) {
                ...
                (n.prototype = new o.default()),
                        ...
                        for (var n = e.body, l = 0, s = n.length; l < s; l++) {
                            ...
                            if (u) {
                                ...
                                u.close && i(n, l, !0),
                                    ...
                                    t &&
                                        y &&
                                        (i((d.program || d.inverse).body),
                                        p(n, l)),
                                    t &&
                                        S &&
                                        (i(n, l),
                                        p((d.inverse || d.program).body));
                            }
                        }
                        return e;
                    }),
                    (n.prototype.BlockStatement =
                        ...
                        n.prototype.PartialBlockStatement =
                            function (e) {
                                ...
                                if (
                                    (e.openStrip.close && i(t.body, null, !0),
                                    o)
                                ) {
                    ...
                    (n.prototype.PartialStatement =
                        n.prototype.CommentStatement =
                            function (e) {
                                var t = e.strip || {};
                                return {
                                    inlineStandalone: !0,
        ...
        b1zW: [
            function (require, module, exports) {
                ...
                function o(t, r) {
                    if (
                        ((r = r.path ? r.path.original : r),
                        t.path.original !== r)
                    ) {
                        var o = { loc: t.path.loc };
                        throw new e.default(
                            t.path.original + " doesn't match " + r,
                            o
                        );
                    }
                }
                ...
                function i(t, r, o) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            if (n.length > 0)
                                throw new e.default("Invalid path: " + a, {
                                    loc: o,
                                });
                            ".." === c && p++;
                        }
        ...
        O25j: [
                ...
                function h(e, t, i) {
                    ...
                    function a() {
                        var s = i.parse(e, t),
                            ...
                            r = new i.JavaScriptCompiler().compile(
                                o,
                                t,
                                void 0,
                                !0
                ...
                p.prototype = {
                    ...
                    equals: function (e) {
                        ...
                        for (var s = 0; s < t; s++) {
                            var o = this.opcodes[s],
                                i = e.opcodes[s];
                            if (o.opcode !== i.opcode || !l(o.args, i.args))
                                return !1;
                        }
                        t = this.children.length;
                        for (s = 0; s < t; s++)
                            if (!this.children[s].equals(e.children[s]))
                                return !1;
                        return !0;
                    },
                    guid: 0,
                    ...
                    setupFullMustacheParams: function (e, t, s, o) {
                        ...
                        return (
                            ...
                            e.hash
                                ? this.accept(e.hash)
                                : this.opcode("emptyHash", o),
                            i
                        );
                    },
                    blockParamIndex: function (e) {
                        for (
                            var t = 0, s = this.options.blockParams.length;
                            t < s;
                            t++
                        ) {
            ...
            { "../exception": "Whac", "../utils": "cXff", "./ast": "WQqK" },
        ],
        YNEz: [
            function (require, module, exports) {
                var e =
                    ...
                    (exports.decode = function (n, i, a) {
                        ...
                        do {
                            ...
                            if (-1 === (u = e.decode(n.charCodeAt(i++))))
                                throw new Error(
                                    "Invalid base64 digit: " + n.charAt(i - 1)
                                );
                            (c = !!(u & t)), (s += (u &= o) << v), (v += r);
                        } while (c);
        ...
        dghU: [
            function (require, module, exports) {
                ...
                (n.fromArray = function (t, e) {
                    for (var r = new n(), i = 0, s = t.length; i < s; i++)
                        r.add(t[i], e);
                    return r;
                }),
                ...
                (r.prototype._version = 3),
                        ...
                        return (
                            e.eachMapping(function (e) {
                                ...
                                null != e.source &&
                                    ((r.source = e.source),
                                    null != o &&
                                        (r.source = n.relative(o, r.source)),
                                    (r.original = {
                                        line: e.originalLine,
                    ...
                    (r.prototype.setSourceContent = function (e, o) {
                        ...
                        null != this._sourceRoot &&
                            (t = n.relative(this._sourceRoot, t)),
                            null != o
                        ...
                        this._mappings.unsortedForEach(function (o) {
                            if (o.source === i && null != o.originalLine) {
                                ...
                                null != t.source &&
                                    ((o.source = t.source),
                                    null != r &&
                                        (o.source = n.join(r, o.source)),
                                    null != s &&
                                        (o.source = n.relative(s, o.source)),
                ...
                (exports.GREATEST_LOWER_BOUND = 1),
                    ...
                    (exports.search = function (t, e, E, n) {
                        ...
                        var o = r(
                            ...
                            e,
                            E,
                            n || exports.GREATEST_LOWER_BOUND
                        );
                        if (o < 0) return -1;
            ...
            function (require, module, exports) {
                ...
                (i.fromSourceMap = function (e, n) {
                    ...
                    (i.prototype.eachMapping = function (n, r, t) {
                        ...
                        o.map(function (n) {
                            var r =
                                null === n.source
                                    ? null
                                    : this._sources.at(n.source);
                            return {
                                source: (r = e.computeSourceURL(
                                    a,
                                    r,
                                    this._sourceMapURL
                                )),
                    ...
                    (i.prototype.allGeneratedPositionsFor = function (r) {
                        ...
                        if (
                            ((o.source = this._findSourceIndex(o.source)),
                            o.source < 0)
                        )
                            return [];
                        var i = [],
                    ...
                    (s.prototype._findSourceIndex = function (n) {
                        ...
                        if (
                            (null != this.sourceRoot &&
                                (t = e.relative(this.sourceRoot, t)),
                            this._sources.has(t))
                        )
                    ...
                    (s.fromSourceMap = function (n, t) {
                        var i = Object.create(s.prototype),
                            u = (i._names = r.fromArray(
                                n._names.toArray(),
                                !0
                            )),
                            l = (i._sources = r.fromArray(
                                n._sources.toArray(),
                                !0
                            ));
                        ...
                        for (
                            ...
                            if (";" === n.charAt(C)) p++, C++, (c = 0);
                                ...
                                for (
                                    ...
                                    l < d &&
                                    !this._charIsMappingSeparator(n, l);
                                    l++
                                );
                    ...
                    (s.prototype.sourceContentFor = function (n, r) {
                        ...
                        if (
                            (null != this.sourceRoot &&
                                (i = e.relative(this.sourceRoot, i)),
                            null != this.sourceRoot &&
                                (o = e.urlParse(this.sourceRoot)))
                        ) {
                            var s = i.replace(/^file:\/\//, "");
                            if ("file" == o.scheme && this._sources.has(s))
                                return this.sourcesContent[
                                    this._sources.indexOf(s)
                                ];
                            if (
                                (!o.path || "/" == o.path) &&
                                this._sources.has("/" + i)
                        ...
                        get: function () {
                            for (
                                ...
                                for (
                                    var r = 0;
                                    r <
                                    this._sections[n].consumer.sources.length;
                                    r++
                                )
                                    e.push(
                                        this._sections[n].consumer.sources[r]
                                    );
                            return e;
                        },
                    }),
                        ...
                        var t = {
                            ...
                            o = n.search(t, this._sections, function (e, n) {
                                ...
                                return (
                                    r ||
                                    e.generatedColumn -
                                        n.generatedOffset.generatedColumn
                                );
                            }),
                            i = this._sections[o];
                        return i
                            ? i.consumer.originalPositionFor({
                                  ...
                                  column:
                                      ...
                                      t.generatedLine
                                          ? i.generatedOffset.generatedColumn -
                                            1
                                          : 0),
                                  bias: r.bias,
                              })
                    ...
                    (u.prototype.sourceContentFor = function (e, n) {
                        for (var r = 0; r < this._sections.length; r++) {
                            var t = this._sections[r].consumer.sourceContentFor(
                                e,
                                !0
                            );
                            if (t) return t;
                ...
                (i.fromStringWithSourceMap = function (n, t, o) {
                    ...
                    (i.prototype.walkSourceContents = function (n) {
                        for (var r = 0, t = this.children.length; r < t; r++)
                            this.children[r][o] &&
                                this.children[r].walkSourceContents(n);
        ...
        aRf0: [
            function (require, module, exports) {
                (exports.SourceMapGenerator =
                    ...
                    (exports.SourceNode =
                        require("./lib/source-node").SourceNode);
            },
            {
                ...
                e ||
                    ...
                    (s.prototype = {
                        ...
                        generateList: function (t) {
                            for (
                                var r = this.empty(), e = 0, n = t.length;
                                e < n;
                                e++
                            )
            ...
            function (require, module, exports) {
                ...
                (h.prototype = {
                    ...
                    invokePartial: function (t, s, e) {
                        ...
                        t && ((s = this.popStack()), delete r.name),
                            ...
                            t
                                ? i.unshift(s)
                                : i.unshift(
                                      this.nameLookup("partials", s, "partial")
                                  ),
                    ...
                    popStack: function (t) {
                        var s = this.isInline(),
                            e = (
                                s ? this.inlineStack : this.compileStack
                            ).pop();
                        if (!t && e instanceof o) return e.value;
                        if (!s) {
                            if (!this.stackSlot)
                                throw new i.default("Invalid stack pop");
                            this.stackSlot--;
                        }
                        return e;
                    },
                    ...
                    aliasable: function (t) {
                        ...
                        return s
                            ? (s.referenceCount++, s)
                            : (((s = this.aliases[t] =
                                  this.source.wrap(t)).aliasable = !0),
                              (s.referenceCount = 1),
                              s);
                    },
                    ...
                    setupParams: function (t, s, e) {
                        ...
                        return (
                            ...
                            this.trackIds &&
                                (i.ids = this.source.generateArray(a)),
                            this.stringParams &&
        ...
        WNU3: [
            ...
            {
                "./handlebars.runtime": "LmTF",
                "./handlebars/compiler/ast": "WQqK",
                "./handlebars/compiler/base": "h3Tq",
                "./handlebars/compiler/compiler": "O25j",
                "./handlebars/compiler/javascript-compiler": "Be35",
                "./handlebars/compiler/visitor": "CMGx",
                "./handlebars/no-conflict": "Pvge",
            },
        ],
        pkZH: [
            function (require, module, exports) {
                ...
                (i.prototype = new a.default()),
                    (i.prototype.pad = function (t) {
                        for (var r = "", a = 0, e = this.padding; a < e; a++)
                            r += "  ";
                        return (r += t + "\n");
                    }),
                    ...
                    (i.prototype.Decorator = function (t) {
                        return this.pad(
                            "{{ DIRECTIVE " + this.SubExpression(t) + " }}"
                        );
                    }),
                    (i.prototype.BlockStatement = i.prototype.DecoratorBlock =
                        function (t) {
                            var r = "";
                            return (
                                (r += this.pad(
                                    ("DecoratorBlock" === t.type
                                        ? "DIRECTIVE "
                                        : "") + "BLOCK:"
                                )),
                                this.padding++,
                    ...
                    (i.prototype.SubExpression = function (t) {
                        for (
                            var r, a = t.params, e = [], i = 0, n = a.length;
                            i < n;
                            i++
                        )
                    ...
                    (i.prototype.Hash = function (t) {
                        for (
                            var r = t.pairs, a = [], e = 0, i = r.length;
                            e < i;
                            e++
                        )
        ...
        pEcb: [
            ...
            {
                "../dist/cjs/handlebars": "WNU3",
                "../dist/cjs/handlebars/compiler/printer": "pkZH",
                fs: "rDCW",
            },
        ],
        mGne: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0);
                var e = r(require("handlebars"));
                function r(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                const t = {};
                e.default.registerHelper({
                    equal: (e, r) => e === r,
                    notequal: (e, r) => e !== r,
                    and() {
                    ...
                    (t.resolve = (r, t, o = { noEscape: !0, strict: !0 }) =>
                        e.default.compile(t, o)(r)),
                    (t.skipIfsResolve = (r, o) => (
                        e.default.registerHelper("if", (e, r) => r.fn(void 0)),
                        t.resolve(r, o, { noEscape: !0, strict: !1 })
                    )),
                    (t.verify = (r, t) => {
                        e.default.compile(t)(r);
                    });
                var o = t;
                exports.default = o;
            },
                            ...
                            function (e, t, r, y) {
                                ...
                                var u = r ? "getUTC" : "get",
                                    ...
                                    S = {
                                        ...
                                        m: T + 1,
                                        mm: i(T + 1),
                                        mmm: s.i18n.monthNames[T],
                                        mmmm: s.i18n.monthNames[T + 12],
                                        yy: String(g).slice(2),
                                        yyyy: g,
                                        h: c % 12 || 12,
                                        hh: i(c % 12 || 12),
        ...
        sPhZ: [
            function (require, module, exports) {
                ...
                async function s(e = "") {
                    ...
                    return (
                        (
                            await fetch(`${s}/META-INF/MANIFEST.MF`)
                                .then((t) => t.text())
                                .catch((t) => {
                                    throw new Error(
                                        "Can not fetch the MANIFEST.MF"
                                    );
                                })
                        )
                            .split(/\r?\n/g)
                            .forEach((e) => {
                                const s = e.split(": ");
                                if ("Git-CommitTime" !== s[0]) return;
                                const n = new Date(s[1]);
                                r = (0, t.default)(n, "yyyy-mm-dd HH:MM:ss");
                            }),
                        r
                    );
                }
                r.beautify = async (t, e = "") => {
                    let r = `<div class="grc">\n${(t =
                        '<meta http-equiv="content-type" content="text/html;charset=UTF-8" />\n' +
                        (t =
                            `<link rel="stylesheet" href="${
                                e || ".."
                            }/rules/css/generic.css" type="text/css" />` +
                            "\n" +
                            t))}\n${`<div id="manifest_timestamp" style="margin-top:10px;">${await s(
                        e
                    )}</div>`}</div>`;
                    return (
                        e && (r = r.replace(/src="..\//g, 'src="' + e + "/")), r
                    );
                };
                var n = r;
                exports.default = n;
        ...
        jVaz: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0);
                var e = o(require("./contentGenerator")),
                    t = o(require("./templateResolver")),
                    r = u(require("./templateReader")),
                    a = o(require("./beautifyGameRules"));
                function n() {
                ...
                const l = {
                    canRenderRuntime: async (e, t) => {
                        const a = await (0, r.fetchTemplateName)(e, t);
                        return await fetch(
                            `${t}/rules/templates/${a}.hbs`
                        ).then((e) => 404 !== e.status);
                    },
                    render: async (n, u, o, l) => {
                        const f = e.default.generate(u, o, l),
                            i = await (0, r.fetchTemplateName)(n, l),
                            s = r.default.readTemplate(i, l);
                        return Promise.all([f, s]).then(async (e) => {
                            const r = e[0],
                                n = e[1],
                                u = await a.default.beautify(n, l);
                            return t.default.resolve(r, u);
                        });
                    },
                    verify: (e) => {
                        t.default.verify({}, e);
                    },
                    renderAllowMissingKeys: (e, r) =>
                        t.default.skipIfsResolve(e, r),
                };
                var f = l;
                exports.default = f;
            },
            {
                "./contentGenerator": "Xl3Y",
                "./templateResolver": "mGne",
                "./templateReader": "HDNH",
                "./beautifyGameRules": "sPhZ",
            },
        ],
        GVj2: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0);
                var e = r(require("./rulesRenderAPI"));
                function r(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                var t = e.default;
        ...
        JWvI: [
            function (require, module, exports) {
                // "use strict";function e(e,t,n,r,u,a,c){try{var o=e[a](c),i=o.value}catch(s){return void n(s)}o.done?t(i):Promise.resolve(i).then(r,u)}function t(t){return function(){var n=this,r=arguments;return new Promise(function(u,a){var c=t.apply(n,r);function o(t){e(c,u,a,o,i,"next",t)}function i(t){e(c,u,a,o,i,"throw",t)}o(void 0)})}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var n={};n.fetch=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,u(t);case 2:return a=e.sent,e.next=5,r(t.gameId,n).then(function(e){for(var t in e)a[t]=e[t]}).catch(function(){});case 5:return e.abrupt("return",a);case 6:case"end":return e.stop()}},e)}));return function(t,n){return e.apply(this,arguments)}}();var r=function(){var e=t(regeneratorRuntime.mark(function e(t,n){var r,u,a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=t.replace("_sw",""),u="".concat(n,"/rules/templates_config.json"),e.next=4,fetch(u).then(function(e){return 404!==e.status?e.json():Promise.reject("File not found")}).then(function(e){return e[r]});case 4:return a=e.sent,e.abrupt("return",a?a.values:{});case 6:case"end":return e.stop()}},e)}));return function(t,n){return e.apply(this,arguments)}}(),u=function(){var e=t(regeneratorRuntime.mark(function e(t){var n,r,u,c;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.server,r=t.gameId,u=t.sessId,c=t.jurisdictionCode,e.next=3,a(n,r,u,c).then(function(e){var t={};return e.split("&").forEach(function(e){var n=e.split("=");t[n[0]]=n[1]}),t}).catch(function(e){throw e});case 3:return e.abrupt("return",e.sent);case 4:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),a=function(){var e=t(regeneratorRuntime.mark(function e(t,n,r,u){var a;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a="".concat(t,"/servlet/CasinoGameServlet;jsession=").concat(r,"?action=init&gameId=").concat(n,"&sessid=").concat(r),a+=u?"&jurisdictionCode=".concat(u):"",e.next=4,fetch(a).then(function(e){return e.text()});case 4:return e.abrupt("return",e.sent);case 5:case"end":return e.stop()}},e)}));return function(t,n,r,u){return e.apply(this,arguments)}}(),c=n;exports.default=c;
            },
            {},
        ],
        iJA9: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.MAX_BET =
                        exports.BETTING_MODES_LEGACY =
                        exports.BETTING_MODES =
                        exports.SHOW_MAX_WIN_PROBABILITY =
                        exports.STOP_AUTOPLAY_ON_BONUS_GAMES =
                        exports.QUICK_SPIN_AVAILABLE =
                            void 0);
                var e = "config.gameParameters.quickSpinAvailable";
                exports.QUICK_SPIN_AVAILABLE = e;
                var r = "config.gameParameters.stopAutoplayOnBonusGames";
                exports.STOP_AUTOPLAY_ON_BONUS_GAMES = r;
                var a = "config.gameParameters.showMaxWinProbability";
                exports.SHOW_MAX_WIN_PROBABILITY = a;
                var t = "config.gameParameters.bettingModes";
                exports.BETTING_MODES = t;
                var o = "config.urlParameters.bettingModes";
                exports.BETTING_MODES_LEGACY = o;
                var s = "config.gameParameters.maxBet";
                exports.MAX_BET = s;
            },
            {},
        ],
        x2TJ: [
            function (require, module, exports) {
                ...
                var n = require("./constants"),
                    t = function (n, t, o) {
                        var u = {};
                        return r(u, n), r(u, t), r(u, o), e(u);
                    };
                exports.manageData = t;
                var r = function (n, t) {
                    ...
                    c = function (n) {
                        return "cash" !== n && "coins" !== n ? "both" : n;
                    },
                    a = [];
                (a[n.BETTING_MODES] = c), (a[n.BETTING_MODES_LEGACY] = c);
            },
            { "./constants": "iJA9" },
        ],
        FYrP: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0);
                var e = a(require("@netent/gamerules-renderer")),
                    r = a(require("./fetchData")),
                    t = require("./manageData"),
                    n = require("./constants");
                function a(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                function u(e, r, t, n, a, u, o) {
                    try {
                        var i = e[u](o),
                            c = i.value;
                    } catch (s) {
                ...
                var i = {},
                    c = { showRtp: "true", autoplay: "10" };
                (c[n.QUICK_SPIN_AVAILABLE] = "true"),
                    (c[n.SHOW_MAX_WIN_PROBABILITY] = "false"),
                    (c[n.STOP_AUTOPLAY_ON_BONUS_GAMES] = "false"),
                    (c[n.BETTING_MODES] = "both"),
                    (c[n.BETTING_MODES_LEGACY] = "both"),
                    (c[n.MAX_BET] = "true"),
                    (i.renderRules = (function () {
                        var a = o(
                            regeneratorRuntime.mark(function a(u) {
                                var o, i;
                    ...
                    (i.canRenderRuntime = (function () {
                        var r = o(
                            regeneratorRuntime.mark(function r(t, n) {
            ...
            {
                "@netent/gamerules-renderer": "GVj2",
                "./fetchData": "JWvI",
                "./manageData": "x2TJ",
                "./constants": "iJA9",
            },
        ...
        b7LN: [
            function (require, module, exports) {
                ...
                var e = n(require("./legacyFlow")),
                    r = n(require("./runtimeRenderingFlow")),
                    t = require("./constants");
                function n(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                                ...
                                for (;;)
                                    switch ((n.prev = n.next)) {
                                        case 0:
                                            for (i in (a["bettingModes.0"] &&
                                                ((u = a["bettingModes.1"]
                                                    ...
                                                    : a["bettingModes.0"]),
                                                (a[t.BETTING_MODES] = u),
                                                (a[t.BETTING_MODES_LEGACY] =
                                                    u)),
                                            void 0 !== a.maxBet &&
                                                (a[t.MAX_BET] = a.maxBet),
                                            a))
                                                a.hasOwnProperty(i) &&
                                                    (a[i] = a[i]
                                                        ? a[i].toString()
                                        ...
                                        case 9:
                                            return (
                                                (p = n.sent),
                                                (g = s(p, a.staticServer)),
                                                (n.next = 13),
                                                r.default.canRenderRuntime(
                                                    a.gameId,
                                                    g
                                                )
                                            );
                ...
                var o = (function () {
                                            ...
                                            case 0:
                                                return (
                                                    ...
                                                    fetch(
                                                        "".concat(
                                                            n,
                                                            "/gameinclusion/directory/directory.json"
                                                        )
                                                    )
                                                        .then(function (e) {
                                                            return e.json();
                    ...
                    s = function (e, r) {
                        var t = e.split("/");
                        return t.pop(), r + "/" + t.join("/");
                    };
                function c(e) {
                    return ["lang", "gameId", "server", "sessId"]
                        .filter(function (r) {
        ...
        XbLW: [
            function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                    (exports.default = void 0),
                    require("regenerator-runtime/runtime");
                var e = n(require("./renderer")),
                    r = require("./constants");
                function n(e) {
                    return e && e.__esModule ? e : { default: e };
                }
                function t(e, r, n, t, a, o, u) {
                    try {
                        var i = e[o](u),
                            s = i.value;
                    } catch (c) {
                ...
                var o = (function () {
                    ...
                    u = function () {
                        for (var e = "DEMO-", r = 0; r < 17; r++)
                            e += Math.floor(10 * Math.random());
                        return e + "-EUR";
                    };
                window.rulesRenderer = o;
                var i = o;
                exports.default = i;
            },
            {
...
//# sourceMappingURL=rules_renderer.js.map
