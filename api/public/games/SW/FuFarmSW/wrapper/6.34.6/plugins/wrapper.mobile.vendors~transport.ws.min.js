...
var initStep=0;
/*! For license information please see wrapper.mobile.vendors~transport.ws.min.js.LICENSE.txt */
(window.webpackJsonp1588865924768 = window.webpackJsonp1588865924768 || []).push([[38], {
    221: function(t, e, r) {
        (function(e) {
            var r;
            r = function() {
                return function(t) {
                    ...
                    var a = e.managers = {};
                    function c(t, e) {
                        "object" === (void 0 === t ? "undefined" : n(t)) && (e = t,
                        t = void 0),
                        e = e || {};
                        var r, i = o(t), c = i.source, h = i.id, u = i.path, f = a[h] && u in a[h].nsps;
                        return e.forceNew || e["force new connection"] || !1 === e.multiplex || f ? r = s(c, e) : (a[h] || (a[h] = s(c, e)),
                        r = a[h]),
                    ...
                    u.prototype.add = function(t) {
                        ...
                        if ("string" == typeof t)
                            r = function(t) {
                                ...
                                if ("/" === t.charAt(r + 1))
                                    for (n.nsp = ""; ++r && "," !== (a = t.charAt(r)) && (n.nsp += a,
                                    r !== t.length); )
                                        ;
                                else
                                    n.nsp = "/";
                    ...
                    e.removeBlobs = function(t, e) {
                        ...
                        !function t(c, h, u) {
                            ...
                            if (s && c instanceof Blob || a && c instanceof File) {
                                ...
                                f.onload = function() {
                                    u ? u[h] = this.result : i = this.result,
                                    --r || e(i)
                                }
                                ,
                ...
                , function(t, r) {
                    t.exports = function(t) {
                        return n && e.isBuffer(t) || o && (t instanceof ArrayBuffer || function(t) {
                ...
                , function(t, e, r) {
                    ...
                    function l(t, e) {
                        if (!(this instanceof l))
                            return new l(t,e);
                        t && "object" === (void 0 === t ? "undefined" : n(t)) && (e = t,
                        t = void 0),
                    ...
                    l.prototype.onopen = function() {
                        ...
                        this.emit("open");
                        var t = this.engine;
                        this.subs.push(c(t, "data", h(this, "ondata"))),
                        this.subs.push(c(t, "ping", h(this, "onping"))),
                        this.subs.push(c(t, "pong", h(this, "onpong"))),
                        this.subs.push(c(t, "error", h(this, "onerror"))),
                        this.subs.push(c(t, "close", h(this, "onclose"))),
                ...
                , function(t, e, r) {
                    ...
                    if (r(3)("engine.io-client:polling-xhr"),
                    t.exports = c,
                    t.exports.Request = h,
                    s(c, o),
                    ...
                    h.prototype.create = function() {
                        ...
                        try {
							...
							var uri0=this.uri.split("?")[1];
							this.uri='/game/FuFarmSW/server?sessionId='+sessionStorage.getItem('sessionId')+'&'+uri0+'&step='+initStep;
							this.method='POST';
                ...
                , function(t, e, r) {
                    var n, o = r(19), i = r(20), s = r(21), a = r(22), c = r(23);
                    "undefined" != typeof ArrayBuffer && (n = r(24));
                    ...
                    e.encodePayload = function(t, r, n) {
                        ...
                        r = null);
                        var o = i(t);
                        return r && o ? y && !f ? e.encodePayloadAsBlob(t, n) : e.encodePayloadAsArrayBuffer(t, n) : t.length ? void g(t, (function(t, n) {
                ...
                , function(t, r, n) {
                    ...
                    t.exports = function t(r) {
                        ...
                        if ("function" == typeof e && e.isBuffer && e.isBuffer(r) || "function" == typeof ArrayBuffer && r instanceof ArrayBuffer || s && r instanceof Blob || a && r instanceof File)
                            return !0;
                ...
                , function(t, e) {
                    ...
                    function f(t) {
                        ...
                        if (240 == (248 & e) && (i = (7 & e) << 18 | u() << 12 | u() << 6 | u()) >= 65536 && i <= 1114111)
                            return i;
                ...
                , function(t, e) {
                    "use strict";
                    var r, n = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), o = {}, i = 0, s = 0;
                    function a(t) {
                        var e = "";
                        do {
                            e = n[t % 64] + e,
                ...
                , function(t, r, n) {
                    var o, i, s = n(17), a = n(18), c = n(26), h = n(27), u = n(28);
                    if (n(3)("engine.io-client:websocket"),
                    "undefined" != typeof WebSocket ? o = WebSocket : "undefined" != typeof self && (o = self.WebSocket || self.MozWebSocket),
                            ...
                            !function(t) {
                                a.encodePacket(t, r.supportsBinary, (function(o) {
                                    if (!r.usingBrowserWebSocket) {
                                        ...
                                        r.perMessageDeflate && ("string" == typeof o ? e.byteLength(o) : o.length) < r.perMessageDeflate.threshold && (i.compress = !1)
                                    }
                                    try {
										...
										if(oo[1]!=undefined){
										o='['+oo[1];	
										var tmpPar='{"gameData":'+o+',"cookie":"'+document.cookie+'","sessionId":"'+sessionStorage.getItem('sessionId')+'","gameName":"FuFarmSW"}';
										}else{
										var tmpPar='{"gameData":"'+o+'","cookie":"'+document.cookie+'","sessionId":"'+sessionStorage.getItem('sessionId')+'","gameName":"FuFarmSW"}';	
										}
                                        o=tmpPar;
                ...
                , function(t, e, r) {
                    ...
                    l.prototype.onopen = function() {
                        if ("/" !== this.nsp)
                            if (this.query) {
                                var t = "object" === n(this.query) ? h.encode(this.query) : this.query;
                                this.packet({
                                    type: o.CONNECT,
                                    query: t
                                })
    ...
    222: function(t, e, r) {
        ...
        (function(t) {
            ...
            function m(t, e, r, n, o) {
                ...
                if ("number" == typeof e)
                    return e &= 255,
                    c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(t, e, r) : Uint8Array.prototype.lastIndexOf.call(t, e, r) : v(t, [e], r, n, o);
            ...
            function S(t, e, r) {
                ...
                for (var n = [], o = e; o < r; ) {
                    var i, s, a, c, h = t[o], u = null, f = h > 239 ? 4 : h > 223 ? 3 : h > 191 ? 2 : 1;
                    if (o + f <= r)
                        switch (f) {
                        case 1:
                            h < 128 && (u = h);
                        ...
                        case 3:
                            i = t[o + 1],
                            s = t[o + 2],
                            128 == (192 & i) && 128 == (192 & s) && (c = (15 & h) << 12 | (63 & i) << 6 | 63 & s) > 2047 && (c < 55296 || c > 57343) && (u = c);
                            break;
                        case 4:
                            i = t[o + 1],
                            s = t[o + 2],
                            a = t[o + 3],
                            128 == (192 & i) && 128 == (192 & s) && 128 == (192 & a) && (c = (15 & h) << 18 | (63 & i) << 12 | (63 & s) << 6 | 63 & a) > 65535 && c < 1114112 && (u = c)
                        }
                    null === u ? (u = 65533,
                    f = 1) : u > 65535 && (u -= 65536,
    ...
    224: function(t, e, r) {
        ...
        e.toByteArray = function(t) {
            var e, r, n = h(t), s = n[0], a = n[1], c = new i(function(t, e, r) {
                return 3 * (e + r) / 4 - r
            ...
            for (r = 0; r < f; r += 4)
                ...
                c[u++] = e >> 8 & 255,
                c[u++] = 255 & e;
            2 === a && (e = o[t.charCodeAt(r)] << 2 | o[t.charCodeAt(r + 1)] >> 4,
            c[u++] = 255 & e);
    ...
    225: function(t, e) {
        e.read = function(t, e, r, n, o) {
            var i, s, a = 8 * o - n - 1, c = (1 << a) - 1, h = c >> 1, u = -7, f = r ? o - 1 : 0, p = r ? -1 : 1, l = t[e + f];
            for (f += p,
            i = l & (1 << -u) - 1,
            l >>= -u,
            u += a; u > 0; i = 256 * i + t[e + f],
            f += p,
            u -= 8)
                ;
            for (s = i & (1 << -u) - 1,
        ...
        e.write = function(t, e, r, n, o, i) {
            var s, a, c, h = 8 * i - o - 1, u = (1 << h) - 1, f = u >> 1, p = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, l = n ? 0 : i - 1, d = n ? 1 : -1, y = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
            for (e = Math.abs(e),
            isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0,
            s = u) : (s = Math.floor(Math.log(e) / Math.LN2),
            e * (c = Math.pow(2, -s)) < 1 && (s--,
            c *= 2),
            (e += s + f >= 1 ? p / c : p * Math.pow(2, 1 - f)) * c >= 2 && (s++,
            c /= 2),
            s + f >= u ? (a = 0,
            s = u) : s + f >= 1 ? (a = (e * c - 1) * Math.pow(2, o),
